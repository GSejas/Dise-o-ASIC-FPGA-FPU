! Test program for debug mdct core
        ...
        .data
arr:    .word	31,30,29,28,27,26,25,24,23,22,21,20       ! allocate an array of 20 words
        .word   19,18,17,16,15,14,13,12,11,10,9,8       ! allocate a word to hold the sum
...
start:  set     arr, %r2            ! %r2 is the base address
	...
	set	32, %r6		    ! size of the array is 32
	...
	set	50,%r5		    ! %r5 repeats the following loop in order
