...
start: 
	...
	set	5,%r5		    ! %r5 is the control value for ddm
				    ! interrumpt enabled, interruptrequest & ddm enabl
	st	%r5,[%r2]	    ! enables ddm without irqen
	...
	nop
	nop
	st	%r6,[%r3]	    ! 2 time mdct
	nop
	nop	
	st	%r6,[%r3]	    ! 3 time mdct
	nop
	nop	
	st	%r6,[%r3]	    ! 4 time mdct
	nop
	nop	
	st	%r6,[%r3]	    ! 5 time mdct
	nop
	nop	
	st	%r6,[%r3]	    ! 6 time mdct
	nop
	nop	
