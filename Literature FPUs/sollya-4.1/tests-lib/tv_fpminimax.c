...
sollya_obj_t stupid_wrapper(sollya_obj_t arg1, sollya_obj_t arg2, sollya_obj_t arg3, sollya_obj_t arg4, ...) {
  ...
  sollya_obj_t a;
  va_start(va, arg4);
  a = sollya_lib_v_fpminimax(arg1, arg2, arg3, arg4, va);
  va_end(va);
  return a;
}
...
int main(void) {
  ...
  P = stupid_wrapper(f, n, formats, I, fp, mode, constrainedpart, pstar, NULL);
  ...
  constrainedpart = sollya_lib_default();
  tmp1 = stupid_wrapper(f, n, formats, I, fp, mode, constrainedpart, pstar, NULL);
  ...
  fp = sollya_lib_default();
  mode = sollya_lib_default();
  tmp1 = stupid_wrapper(f, n, formats, I, constrainedpart, fp, mode, pstar, NULL);
  P = sollya_lib_horner(tmp1);
  sollya_lib_clear_obj(tmp1);
  powers = sollya_lib_powers();
  sollya_lib_set_display(powers);
  ...
  P1 = stupid_wrapper(f, n, formats, I, mode, constrainedpart, fp, pstar, NULL);
  sollya_lib_clear_obj(formats);

  formats = sollya_lib_parse_string("[|D...|]");
  P2 = stupid_wrapper(f, n, formats, I, mode, constrainedpart, fp, pstar, NULL);
  sollya_lib_clear_obj(formats);

  formats = sollya_lib_parse_string("[|D, D, D, 24...|]");
  P3 = stupid_wrapper(f, n, formats, I, mode, constrainedpart, fp, pstar, NULL);
  sollya_lib_clear_obj(formats);
