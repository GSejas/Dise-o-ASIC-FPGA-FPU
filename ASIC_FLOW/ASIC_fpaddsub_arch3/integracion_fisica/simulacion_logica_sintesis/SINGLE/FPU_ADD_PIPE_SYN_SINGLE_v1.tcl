...
# DVE full session
# Saved on Fri Oct 21 17:29:03 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_sintesis/SINGLE/FPU_ADD_PIPE_SYN_SINGLE_v1.tcl" type="Debug">
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 1176} {height 179} {dock_state bottom} {dock_on_new_line false}}
set Watch.1 [gui_create_window -type Watch -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line false -dock_extent 166]
gui_set_window_pref_key -window ${Watch.1} -key dock_width -value_type integer -value 746
gui_set_window_pref_key -window ${Watch.1} -key dock_height -value_type integer -value 166
gui_set_window_pref_key -window ${Watch.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Watch.1} {{left 0} {top 0} {width 182} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
gui_update_layout -id ${List.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_list_left 150} {child_list_right 1204} {child_list_up 115} {child_list_down 284}}
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +lint=all -a log_name +define+SINGLE +define+FRANCIS_LZD=1 +neg_tchk +sdfverbose}}
gui_set_env SIMSETUP::SIMEXE {simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {simv}] } {
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SINGLE +define+FRANCIS_LZD=1 +neg_tchk +sdfverbose -ucligui} -dir ../SINGLE -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 181.441 288.476
...
gui_marker_move -id ${Wave.1} {C1} 188
gui_view_scroll -id ${Wave.1} -vertical -set 832
...
gui_view_scroll -id ${List.1} -vertical -set 300
