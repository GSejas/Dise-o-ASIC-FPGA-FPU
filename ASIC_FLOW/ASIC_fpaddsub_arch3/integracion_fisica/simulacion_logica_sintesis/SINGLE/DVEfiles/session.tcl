...
# DVE full session
# Saved on Fri Oct 21 18:07:27 2016
# Designs open: 1
...
gui_wv_zoom_timerange -id ${Wave.1} 144.521 358.593
...
gui_marker_move -id ${Wave.1} {C1} 217.008
...
gui_view_scroll -id ${List.1} -vertical -set 460
