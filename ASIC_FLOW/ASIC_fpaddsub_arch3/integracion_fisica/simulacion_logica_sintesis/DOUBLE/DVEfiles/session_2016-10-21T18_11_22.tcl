...
# DVE full session
# Saved on Fri Oct 21 18:11:22 2016
# Designs open: 1
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +lint=all -a log_name +define+DOUBLE +define+FRANCIS_LZD=1 +neg_tchk +sdfverbose}}
...
gui_sg_addsignal -group "$_session_group_5" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee }
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}

set _session_group_6 {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee[31:0]@3593}
gui_sg_create "$_session_group_6"
set {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee[31:0]@3593} "$_session_group_6"

gui_sg_addsignal -group "$_session_group_6" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.clk }
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}
...
gui_wv_zoom_timerange -id ${Wave.1} 181.44 288.475
...
gui_list_select -id ${Wave.1} {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X }
...
gui_marker_move -id ${Wave.1} {C1} 214.86
gui_view_scroll -id ${Wave.1} -vertical -set 777
...
gui_view_scroll -id ${List.1} -vertical -set 440
