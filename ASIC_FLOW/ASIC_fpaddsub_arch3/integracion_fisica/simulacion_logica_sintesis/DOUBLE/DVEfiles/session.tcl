...
# DVE full session
# Saved on Fri Oct 21 18:19:03 2016
# Designs open: 1
#   Sim: /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_sintesis/DOUBLE/simv
...
#   Group Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee[31:0]@3593 signal count = 2
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_sintesis/DOUBLE/DVEfiles/session.tcl" type="Debug">
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 454} {height 177} {dock_state bottom} {dock_on_new_line false}}
...
gui_update_layout -id ${Watch.1} {{left 0} {top 0} {width 904} {height 177} {dock_state bottom} {dock_on_new_line false}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 342} {child_wave_right 1012} {child_wave_colname 203} {child_wave_colvalue 138} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_update_layout -id ${List.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_list_left 150} {child_list_right 1204} {child_list_up 115} {child_list_down 296}}
...
gui_set_env SIMSETUP::SIMARGS {{ +v2k +lint=all -a log_name +define+DOUBLE +define+FRANCIS_LZD=1 +neg_tchk +sdfverbose -ucligui}}
gui_set_env SIMSETUP::SIMEXE {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_sintesis/DOUBLE/simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_sintesis/DOUBLE/simv}] } {
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+DOUBLE +define+FRANCIS_LZD=1 +neg_tchk +sdfverbose -ucligui} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_sintesis/DOUBLE -nosource
}
}
...
gui_set_radix -radix {decimal} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.FileSaveData}
gui_set_radix -radix {twosComplement} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.FileSaveData}
...
gui_set_radix -radix {decimal} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.logVectorReference}
gui_set_radix -radix {twosComplement} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.logVectorReference}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}
...
gui_sg_addsignal -group "$_session_group_3" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.clk }
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}
...
gui_watch_list_add_expr -id Watch -expr {Data_X[63:0]} -meta tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X -type Reg -nonlocal -scope tb_FPU_PIPELINED_FPADDSUB2_vector_testing

gui_watch_list_add_expr -id Watch -expr {Data_Y[63:0]} -meta tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y -type Reg -nonlocal -scope tb_FPU_PIPELINED_FPADDSUB2_vector_testing

gui_watch_list_add_expr -id Watch -expr {Theoretical_result[63:0]} -meta tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result -type Reg -nonlocal -scope tb_FPU_PIPELINED_FPADDSUB2_vector_testing

gui_watch_list_add_expr -id Watch -expr {final_result_ieee[63:0]} -meta tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee -type Wire -nonlocal -scope tb_FPU_PIPELINED_FPADDSUB2_vector_testing
...
gui_wv_zoom_timerange -id ${Wave.1} 229.886 272.211
...
gui_list_select -id ${Wave.1} {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.busy tb_FPU_PIPELINED_FPADDSUB2_vector_testing.ready tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group tb_FPU_PIPELINED_FPADDSUB2_vector_testing  -item tb_FPU_PIPELINED_FPADDSUB2_vector_testing.busy -position below

gui_marker_move -id ${Wave.1} {C1} 233.043
...
gui_open_source -id ${Source.1}  -replace -active tb_FPU_PIPELINED_FPADDSUB2_vector_testing /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_sintesis/DOUBLE/tb_FPU_PIPELINED_FPADDSUB2_vector_testing.v
...
gui_view_scroll -id ${List.1} -vertical -set 524
