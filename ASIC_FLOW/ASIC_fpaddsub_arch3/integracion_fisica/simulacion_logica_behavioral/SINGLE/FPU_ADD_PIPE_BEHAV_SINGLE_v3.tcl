...
# DVE full session
# Saved on Thu Oct 20 19:34:25 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_behavioral/SINGLE/FPU_ADD_PIPE_BEHAV_SINGLE_v3.tcl" type="Debug">
...
set _session_group_62 Group1
gui_sg_create "$_session_group_62"
set Group1 "$_session_group_62"

gui_sg_addsignal -group "$_session_group_62" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee }
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}

set _session_group_63 Group2
gui_sg_create "$_session_group_63"
set Group2 "$_session_group_63"

gui_sg_addsignal -group "$_session_group_63" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee }
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}

set _session_group_64 Group3
gui_sg_create "$_session_group_64"
set Group3 "$_session_group_64"

gui_sg_addsignal -group "$_session_group_64" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDX_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDY_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intAS tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.eqXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.gtXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_INIT }

set _session_group_65 Group4
gui_sg_create "$_session_group_65"
set Group4 "$_session_group_65"

gui_sg_addsignal -group "$_session_group_65" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDX_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDY_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intAS tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.eqXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.gtXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_INIT }

set _session_group_66 SHT1_STAGE_DMP
gui_sg_create "$_session_group_66"
set SHT1_STAGE_DMP "$_session_group_66"

gui_sg_addsignal -group "$_session_group_66" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.Q tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.rst }
...
set _session_group_67 SHT1_STAGE_DmP_mant
gui_sg_create "$_session_group_67"
set SHT1_STAGE_DmP_mant "$_session_group_67"
...
set _session_group_68 SHT1_STAGE_FLAGS
gui_sg_create "$_session_group_68"
set SHT1_STAGE_FLAGS "$_session_group_68"

gui_sg_addsignal -group "$_session_group_68" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.Q tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.rst }
...
set _session_group_70 INPUT_STAGE_FLAGS
gui_sg_create "$_session_group_70"
set INPUT_STAGE_FLAGS "$_session_group_70"

gui_sg_addsignal -group "$_session_group_70" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_FLAGS.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_FLAGS.Q tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_FLAGS.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_FLAGS.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_FLAGS.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_FLAGS.rst }
...
set _session_group_71 INPUT_STAGE_OPERANDX
gui_sg_create "$_session_group_71"
set INPUT_STAGE_OPERANDX "$_session_group_71"

gui_sg_addsignal -group "$_session_group_71" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.Q tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.rst }
...
set _session_group_73 INIT
gui_sg_create "$_session_group_73"
set INIT "$_session_group_73"

gui_sg_addsignal -group "$_session_group_73" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDX_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDY_EWSW }

set _session_group_74 $_session_group_73|
append _session_group_74 FLAGS
gui_sg_create "$_session_group_74"
set INIT|FLAGS "$_session_group_74"

gui_sg_addsignal -group "$_session_group_74" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intAS tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.eqXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.gtXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_INIT }

set _session_group_75 EXP
gui_sg_create "$_session_group_75"
set EXP "$_session_group_75"

gui_sg_addsignal -group "$_session_group_75" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_EXP_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_EXP_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_exp_EXP_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_exp_EXP_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_mant_EXP_SW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_mant_EXP_SW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Shift_amount_EXP_EW }

set _session_group_76 $_session_group_75|
append _session_group_76 Group2
gui_sg_create "$_session_group_76"
set EXP|Group2 "$_session_group_76"

gui_sg_addsignal -group "$_session_group_76" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.EXP_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_EXP tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_EXP tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_EXP }

set _session_group_77 SHT1
gui_sg_create "$_session_group_77"
set SHT1 "$_session_group_77"
...
set _session_group_82 NRM
gui_sg_create "$_session_group_82"
set NRM "$_session_group_82"

gui_sg_addsignal -group "$_session_group_82" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_exp_NRM_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Add_Subt_LZD_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Raw_mant_NRM_SWR }

set _session_group_83 $_session_group_82|
append _session_group_83 FLAGS
gui_sg_create "$_session_group_83"
set NRM|FLAGS "$_session_group_83"

gui_sg_addsignal -group "$_session_group_83" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.NRM_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_NRM tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_NRM }

set _session_group_84 FRMT
gui_sg_create "$_session_group_84"
set FRMT "$_session_group_84"

gui_sg_addsignal -group "$_session_group_84" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_output_NRM2_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_exp_NRM2_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_NRM2_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_ZFiller tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.exp_rslt_NRM2_EW1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.formatted_number_W }

set _session_group_85 $_session_group_84|
append _session_group_85 FLAGS
gui_sg_create "$_session_group_85"
set FRMT|FLAGS "$_session_group_85"

gui_sg_addsignal -group "$_session_group_85" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OVRFLW_FLAG_FRMT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.UNDRFLW_FLAG_FRMT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM2 }

set _session_group_86 Group12
gui_sg_create "$_session_group_86"
set Group12 "$_session_group_86"


set _session_group_87 inst_ShiftRegister
gui_sg_create "$_session_group_87"
set inst_ShiftRegister "$_session_group_87"

gui_sg_addsignal -group "$_session_group_87" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.rst tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.in_bit tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.Q }

set _session_group_88 {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.load@0}
gui_sg_create "$_session_group_88"
set {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.load@0} "$_session_group_88"

gui_sg_addsignal -group "$_session_group_88" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.load }

set _session_group_89 Group13
gui_sg_create "$_session_group_89"
set Group13 "$_session_group_89"

gui_sg_addsignal -group "$_session_group_89" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg }

set _session_group_90 {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg@105000}
gui_sg_create "$_session_group_90"
set {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg@105000} "$_session_group_90"

gui_sg_addsignal -group "$_session_group_90" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg }

set _session_group_91 inst_FSM_INPUT_ENABLE
gui_sg_create "$_session_group_91"
set inst_FSM_INPUT_ENABLE "$_session_group_91"

gui_sg_addsignal -group "$_session_group_91" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.init_OPERATION tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.rst tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_input_internal tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_Pipeline_input tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.state_reg tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.state_next }
...
gui_wv_zoom_timerange -id ${Wave.1} 76.533 157.374
...
gui_list_select -id ${Wave.1} {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.init_OPERATION }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group inst_FSM_INPUT_ENABLE  -item tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_input_internal -position below

gui_marker_move -id ${Wave.1} {C1} 109.073
gui_view_scroll -id ${Wave.1} -vertical -set 1469
