...
gui_sg_addsignal -group "$_session_group_14" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intAS tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.gtXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.eqXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_INIT }
...
gui_sg_addsignal -group "$_session_group_27" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OVRFLW_FLAG_FRMT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.UNDRFLW_FLAG_FRMT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM2 }
...
gui_sg_addsignal -group "$_session_group_30" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.load }

set _session_group_31 Group13
gui_sg_create "$_session_group_31"
set Group13 "$_session_group_31"

gui_sg_addsignal -group "$_session_group_31" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg }
...
gui_sg_addsignal -group "$_session_group_35" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR }

set _session_group_36 DriversLoads
gui_sg_create "$_session_group_36"
set DriversLoads "$_session_group_36"

gui_sg_addsignal -group "$_session_group_36" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR }

set _session_group_37 Group15
gui_sg_create "$_session_group_37"
set Group15 "$_session_group_37"

gui_sg_addsignal -group "$_session_group_37" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.shft_value_mux_o_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.NRM_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Shift_amount_SHT1_EWR }
...
gui_sg_addsignal -group "$_session_group_41" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_SINGLE.Codec_32.Data_Dec_i }
