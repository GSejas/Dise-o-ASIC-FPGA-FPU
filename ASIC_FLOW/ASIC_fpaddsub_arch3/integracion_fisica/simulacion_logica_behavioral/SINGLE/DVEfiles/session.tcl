...
# DVE full session
# Saved on Thu Oct 20 20:22:06 2016
# Designs open: 1
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 1359} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
gui_update_layout -id ${List.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_list_left 150} {child_list_right 1204} {child_list_up 115} {child_list_down 286}}
...
gui_set_env SIMSETUP::SIMEXE {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_behavioral/SINGLE/simv}
...
gui_sim_run Ucli -exe simv -args {-ucligui +v2k +lint=all -l log_name +define+SINGLE} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_behavioral/SINGLE -nosource
}
}
...
set _session_group_43 Group1
gui_sg_create "$_session_group_43"
set Group1 "$_session_group_43"

gui_sg_addsignal -group "$_session_group_43" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee }
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}

set _session_group_44 Group2
gui_sg_create "$_session_group_44"
set Group2 "$_session_group_44"

gui_sg_addsignal -group "$_session_group_44" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee }
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}

set _session_group_45 Group3
gui_sg_create "$_session_group_45"
set Group3 "$_session_group_45"

gui_sg_addsignal -group "$_session_group_45" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDX_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDY_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intAS tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.eqXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.gtXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_INIT }

set _session_group_46 Group4
gui_sg_create "$_session_group_46"
set Group4 "$_session_group_46"

gui_sg_addsignal -group "$_session_group_46" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDX_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDY_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intAS tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.eqXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.gtXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_INIT }

set _session_group_47 SHT1_STAGE_DMP
gui_sg_create "$_session_group_47"
set SHT1_STAGE_DMP "$_session_group_47"

gui_sg_addsignal -group "$_session_group_47" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.Q tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.rst }
...
set _session_group_49 SHT1_STAGE_FLAGS
gui_sg_create "$_session_group_49"
set SHT1_STAGE_FLAGS "$_session_group_49"

gui_sg_addsignal -group "$_session_group_49" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.Q tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_FLAGS.rst }
...
set _session_group_50 SHT1_STAGE_sft_amount
gui_sg_create "$_session_group_50"
set SHT1_STAGE_sft_amount "$_session_group_50"

gui_sg_addsignal -group "$_session_group_50" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_sft_amount.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_sft_amount.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_sft_amount.rst tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_sft_amount.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_sft_amount.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_sft_amount.Q }
...
set _session_group_52 INPUT_STAGE_OPERANDX
gui_sg_create "$_session_group_52"
set INPUT_STAGE_OPERANDX "$_session_group_52"

gui_sg_addsignal -group "$_session_group_52" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.Q tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDX.rst }
...
set _session_group_53 INPUT_STAGE_OPERANDY
gui_sg_create "$_session_group_53"
set INPUT_STAGE_OPERANDY "$_session_group_53"

gui_sg_addsignal -group "$_session_group_53" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.rst tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.Q }
...
set _session_group_54 INIT
gui_sg_create "$_session_group_54"
set INIT "$_session_group_54"

gui_sg_addsignal -group "$_session_group_54" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDX_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDY_EWSW }

set _session_group_55 $_session_group_54|
append _session_group_55 FLAGS
gui_sg_create "$_session_group_55"
set INIT|FLAGS "$_session_group_55"

gui_sg_addsignal -group "$_session_group_55" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intAS tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.gtXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.eqXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_INIT }

set _session_group_56 EXP
gui_sg_create "$_session_group_56"
set EXP "$_session_group_56"

gui_sg_addsignal -group "$_session_group_56" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_EXP_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_EXP_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_mant_EXP_SW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_mant_EXP_SW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_exp_EXP_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_exp_EXP_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Shift_amount_EXP_EW }

set _session_group_57 $_session_group_56|
append _session_group_57 Group2
gui_sg_create "$_session_group_57"
set EXP|Group2 "$_session_group_57"

gui_sg_addsignal -group "$_session_group_57" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.EXP_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_EXP tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_EXP tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_EXP }

set _session_group_58 SHT1
gui_sg_create "$_session_group_58"
set SHT1 "$_session_group_58"

gui_sg_addsignal -group "$_session_group_58" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_SHT1_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_mant_SHT1_SW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.sftr_idat_SHT1_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.sftr_odat_SHT1_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Shift_amount_SHT1_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.shft_value_mux_o_EWR }

set _session_group_59 $_session_group_58|
append _session_group_59 Group2
gui_sg_create "$_session_group_59"
set SHT1|Group2 "$_session_group_59"

gui_sg_addsignal -group "$_session_group_59" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.shft_value_mux_o_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.NRM_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Shift_amount_SHT1_EWR }

gui_sg_move "$_session_group_59" -after "$_session_group_58" -pos 3 

set _session_group_60 $_session_group_58|
append _session_group_60 FLAGS
gui_sg_create "$_session_group_60"
set SHT1|FLAGS "$_session_group_60"

gui_sg_addsignal -group "$_session_group_60" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_SHT1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_SHT1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_SHT1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.left_right_SHT1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.bit_shift_SHT1 }

set _session_group_61 SHT2
gui_sg_create "$_session_group_61"
set SHT2 "$_session_group_61"

gui_sg_addsignal -group "$_session_group_61" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_SHT2_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.shift_value_SHT2_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.sftr_idat_SHT2_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.sftr_odat_SHT2_SWR }

set _session_group_62 $_session_group_61|
append _session_group_62 FLAGS
gui_sg_create "$_session_group_62"
set SHT2|FLAGS "$_session_group_62"

gui_sg_addsignal -group "$_session_group_62" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_SHT2 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_SHT2 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_SHT2 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT2_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.left_right_SHT2 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.bit_shift_SHT2 }

set _session_group_63 SGF
gui_sg_create "$_session_group_63"
set SGF "$_session_group_63"

gui_sg_addsignal -group "$_session_group_63" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_mant_SFG_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_mant_SFG_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_exp_SFG tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Raw_mant_SGF tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_SFG }

set _session_group_64 $_session_group_63|
append _session_group_64 FLAGS
gui_sg_create "$_session_group_64"
set SGF|FLAGS "$_session_group_64"

gui_sg_addsignal -group "$_session_group_64" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_SFG tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SFG_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_SFG tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_SFG tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_SGF tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Carry_out_SGF }

set _session_group_65 NRM
gui_sg_create "$_session_group_65"
set NRM "$_session_group_65"

gui_sg_addsignal -group "$_session_group_65" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_exp_NRM_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Add_Subt_LZD_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Raw_mant_NRM_SWR }

set _session_group_66 $_session_group_65|
append _session_group_66 FLAGS
gui_sg_create "$_session_group_66"
set NRM|FLAGS "$_session_group_66"

gui_sg_addsignal -group "$_session_group_66" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.NRM_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_NRM tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_NRM }

set _session_group_67 FRMT
gui_sg_create "$_session_group_67"
set FRMT "$_session_group_67"

gui_sg_addsignal -group "$_session_group_67" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_output_NRM2_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_exp_NRM2_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_NRM2_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_ZFiller tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.exp_rslt_NRM2_EW1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.formatted_number_W }

set _session_group_68 $_session_group_67|
append _session_group_68 FLAGS
gui_sg_create "$_session_group_68"
set FRMT|FLAGS "$_session_group_68"

gui_sg_addsignal -group "$_session_group_68" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OVRFLW_FLAG_FRMT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.UNDRFLW_FLAG_FRMT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM2 }

set _session_group_69 Group12
gui_sg_create "$_session_group_69"
set Group12 "$_session_group_69"


set _session_group_70 inst_ShiftRegister
gui_sg_create "$_session_group_70"
set inst_ShiftRegister "$_session_group_70"

gui_sg_addsignal -group "$_session_group_70" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.rst tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.in_bit tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.Q }

set _session_group_71 {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.load@0}
gui_sg_create "$_session_group_71"
set {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.load@0} "$_session_group_71"

gui_sg_addsignal -group "$_session_group_71" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_ShiftRegister.load }

set _session_group_72 Group13
gui_sg_create "$_session_group_72"
set Group13 "$_session_group_72"

gui_sg_addsignal -group "$_session_group_72" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg }

set _session_group_73 {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg@105000}
gui_sg_create "$_session_group_73"
set {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg@105000} "$_session_group_73"

gui_sg_addsignal -group "$_session_group_73" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg }

set _session_group_74 inst_FSM_INPUT_ENABLE
gui_sg_create "$_session_group_74"
set inst_FSM_INPUT_ENABLE "$_session_group_74"

gui_sg_addsignal -group "$_session_group_74" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.init_OPERATION tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.rst tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_input_internal tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_Pipeline_input tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.enable_shift_reg tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.state_reg tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.inst_FSM_INPUT_ENABLE.state_next }

set _session_group_75 Group14
gui_sg_create "$_session_group_75"
set Group14 "$_session_group_75"

gui_sg_addsignal -group "$_session_group_75" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee }
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}

set _session_group_76 {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR[4:0]@155000}
gui_sg_create "$_session_group_76"
set {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR[4:0]@155000} "$_session_group_76"

gui_sg_addsignal -group "$_session_group_76" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR }

set _session_group_77 DriversLoads
gui_sg_create "$_session_group_77"
set DriversLoads "$_session_group_77"

gui_sg_addsignal -group "$_session_group_77" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR }

set _session_group_78 Group15
gui_sg_create "$_session_group_78"
set Group15 "$_session_group_78"

gui_sg_addsignal -group "$_session_group_78" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.shft_value_mux_o_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.NRM_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Shift_amount_SHT1_EWR }

set _session_group_79 Group16
gui_sg_create "$_session_group_79"
set Group16 "$_session_group_79"


set _session_group_80 Group17
gui_sg_create "$_session_group_80"
set Group17 "$_session_group_80"


set _session_group_81 Group18
gui_sg_create "$_session_group_81"
set Group18 "$_session_group_81"


set _session_group_82 {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR[4:0]@175000}
gui_sg_create "$_session_group_82"
set {Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR[4:0]@175000} "$_session_group_82"

gui_sg_addsignal -group "$_session_group_82" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_SINGLE.Codec_32.Data_Dec_i }

# Global: Highlighting
gui_highlight_signals -color #006400 {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.NRM_ACTIVE}
gui_highlight_signals -color #00ff00 {{tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_SINGLE.Codec_32.Data_Dec_i[25:0]}}
...
gui_view_scroll -id ${Hier.1} -vertical -set 72
gui_view_scroll -id ${Hier.1} -horizontal -set 0

# Data 'Data.1'
gui_list_set_filter -id ${Data.1} -list { {Buffer 1} {Input 1} {Others 1} {Linkage 1} {Output 1} {LowPower 1} {Parameter 1} {All 1} {Aggregate 1} {LibBaseMember 1} {Event 1} {Assertion 1} {Constant 1} {Interface 1} {BaseMembers 1} {Signal 1} {$unit 1} {Inout 1} {Variable 1} }
gui_list_set_filter -id ${Data.1} -text {*}
gui_list_show_data -id ${Data.1} {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut}
...
gui_wv_zoom_timerange -id ${Wave.1} 39.867 232.635
...
gui_list_add_group -id ${Wave.1}  -after SHT1 {SHT1|FLAGS}
gui_list_add_group -id ${Wave.1} -after SHT1|FLAGS {SHT1|Group2}
gui_list_add_group -id ${Wave.1} -after {New Group} {{Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR[4:0]@155000}}
...
gui_list_add_group -id ${Wave.1} -after {New Group} {{Drivers: Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR[4:0]@175000}}
...
gui_list_add_group -id ${Wave.1} -after {New Group} {Group18}
...
gui_list_select -id ${Wave.1} {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group NRM  -item {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR[4:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 179.856
gui_view_scroll -id ${Wave.1} -vertical -set 2514
...
gui_open_source -id ${Source.1}  -replace -active tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_behavioral/SINGLE/../../front_end/source/FPU_ADD_Substract_PIPELINED.v
...
gui_get_drivers -session -id ${DriverLoad.1} -signal {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR[4:0]} -time 155 -starttime 180.309
gui_get_loads -session -id ${DriverLoad.1} -signal {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR[4:0]}
gui_get_drivers -session -id ${DriverLoad.1} -signal {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR[4:0]} -time 175 -starttime 179.856
