...
# DVE full session
# Saved on Fri Oct 28 18:40:40 2016
# Designs open: 1
...
gui_set_env SIMSETUP::SIMEXE {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_cordic_Arch3/integracion_fisica/simulacion_logica_behavioral/SINGLE/simv}
...
gui_sim_run Ucli -exe simv -args {-ucligui +v2k +lint=all -l log_name +define+SINGLE +neg_tchk +sdfverbose} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_cordic_Arch3/integracion_fisica/simulacion_logica_behavioral/SINGLE -nosource
}
}
...
# Restore C1 time
gui_set_time -C1_only 2639565000
...
gui_wv_zoom_timerange -id ${Wave.1} 2639564912 2639565088
...
gui_marker_move -id ${Wave.1} {C1} 2639565000
...
gui_zoom -window ${Schematic.1} -rect { {-17640 -9133} {17620 9077} }
