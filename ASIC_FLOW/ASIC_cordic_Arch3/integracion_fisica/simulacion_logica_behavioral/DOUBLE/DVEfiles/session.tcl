...
# DVE full session
# Saved on Fri Oct 28 18:40:35 2016
# Designs open: 1
#   Sim: /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_cordic_Arch3/integracion_fisica/simulacion_logica_behavioral/DOUBLE/simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_cordic_Arch3/integracion_fisica/simulacion_logica_behavioral/DOUBLE/DVEfiles/session.tcl" type="Debug">
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 446} {child_data_colvalue 272} {child_data_coltype 300} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
if { ![gui_is_db_opened -db {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_cordic_Arch3/integracion_fisica/simulacion_logica_behavioral/DOUBLE/simv}] } {
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+DOUBLE +neg_tchk +sdfverbose -ucligui} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_cordic_Arch3/integracion_fisica/simulacion_logica_behavioral/DOUBLE -nosource
}
}
...
gui_set_radix -radix enum -signals {Sim:testbench_CORDIC_Arch3.Array_IN}
...
# Restore C1 time
gui_set_time -C1_only 564559869
...
gui_list_show_data -id ${Data.1} {testbench_CORDIC_Arch3}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 2639565000
gui_list_add_group -id ${Wave.1} -after {New Group} {testbench_CORDIC_Arch3}
gui_list_select -id ${Wave.1} {testbench_CORDIC_Arch3.data_in }
...
gui_marker_move -id ${Wave.1} {C1} 564559869
...
gui_open_source -id ${Source.1}  -replace -active CORDIC_Arch2 /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_cordic_Arch3/integracion_fisica/simulacion_logica_behavioral/DOUBLE/../../front_end/source/CORDIC_Arch2.v
