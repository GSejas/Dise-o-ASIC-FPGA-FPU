...
# DVE full session
# Saved on Wed Oct 26 16:50:21 2016
# Designs open: 1
#   Sim: /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/KOA_FRANCIS/integracion_fisica/simulacion_logica_behavioral/SINGLE/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: tb_multiplier.inst_Sgf_Multiplication
#   Wave.1: 7 signals
#   Group count = 1
#   Group tb_multiplier signal count = 7
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/KOA_FRANCIS/integracion_fisica/simulacion_logica_behavioral/SINGLE/DVEfiles/session.tcl" type="Debug">
...
gui_set_env SIMSETUP::SIMEXE {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/KOA_FRANCIS/integracion_fisica/simulacion_logica_behavioral/SINGLE/simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/KOA_FRANCIS/integracion_fisica/simulacion_logica_behavioral/SINGLE/simv}] } {
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SINGLE +neg_tchk +sdfverbose -ucligui} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/KOA_FRANCIS/integracion_fisica/simulacion_logica_behavioral/SINGLE -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_1" { tb_multiplier.SW tb_multiplier.a tb_multiplier.b tb_multiplier.i tb_multiplier.FKOARES tb_multiplier.clk tb_multiplier.cycles }
gui_set_radix -radix {decimal} -signals {Sim:tb_multiplier.SW}
gui_set_radix -radix {twosComplement} -signals {Sim:tb_multiplier.SW}
gui_set_radix -radix {decimal} -signals {Sim:tb_multiplier.a}
gui_set_radix -radix {unsigned} -signals {Sim:tb_multiplier.a}
gui_set_radix -radix {decimal} -signals {Sim:tb_multiplier.b}
gui_set_radix -radix {unsigned} -signals {Sim:tb_multiplier.b}
gui_set_radix -radix {decimal} -signals {Sim:tb_multiplier.FKOARES}
gui_set_radix -radix {unsigned} -signals {Sim:tb_multiplier.FKOARES}
...
gui_list_show_data -id ${Data.1} {tb_multiplier.inst_Sgf_Multiplication}
...
gui_wv_zoom_timerange -id ${Wave.1} 8182648 8383216
gui_list_add_group -id ${Wave.1} -after {New Group} {tb_multiplier}
gui_list_select -id ${Wave.1} {tb_multiplier.a tb_multiplier.b tb_multiplier.FKOARES }
...
gui_marker_move -id ${Wave.1} {C1} 8225170
...
gui_open_source -id ${Source.1}  -replace -active tb_multiplier.inst_Sgf_Multiplication /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/KOA_FRANCIS/integracion_fisica/simulacion_logica_behavioral/SINGLE/../../front_end/source/Sgf_Multiplication.v
