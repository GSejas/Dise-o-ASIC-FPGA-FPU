...
# DVE full session
# Saved on Wed Oct 26 16:35:06 2016
# Designs open: 1
...
gui_sg_addsignal -group "$_session_group_2" { tb_multiplier.SW tb_multiplier.a tb_multiplier.b tb_multiplier.i tb_multiplier.FKOARES tb_multiplier.clk tb_multiplier.cycles }
...
gui_wv_zoom_timerange -id ${Wave.1} 0 51300000
gui_list_add_group -id ${Wave.1} -after {New Group} {tb_multiplier}
gui_list_select -id ${Wave.1} {tb_multiplier.FKOARES }
...
gui_marker_move -id ${Wave.1} {C1} 12127205
