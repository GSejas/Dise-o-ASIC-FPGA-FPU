...
# DVE full session
# Saved on Wed Oct 26 16:35:03 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/KOA_FRANCIS/integracion_fisica/simulacion_logica_behavioral/SINGLE/session.inter.vpd.tcl" type="Debug">
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SINGLE +neg_tchk +sdfverbose -ucligui} -dir ../SINGLE -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active tb_multiplier.inst_Sgf_Multiplication /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/KOA_FRANCIS/integracion_fisica/front_end/source/Sgf_Multiplication.v
