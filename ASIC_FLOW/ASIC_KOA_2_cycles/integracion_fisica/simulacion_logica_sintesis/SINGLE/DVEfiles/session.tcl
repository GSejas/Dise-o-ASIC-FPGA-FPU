...
# DVE full session
# Saved on Thu Oct 27 18:26:06 2016
# Designs open: 1
...
#   Wave.1: 10 signals
#   Group count = 1
#   Group tb_multiplier signal count = 10
...
gui_sg_addsignal -group "$_session_group_1" { tb_multiplier.load_b_i tb_multiplier.ERROR tb_multiplier.SW tb_multiplier.a tb_multiplier.b tb_multiplier.i tb_multiplier.FKOARES tb_multiplier.clk tb_multiplier.cycles tb_multiplier.rst }
gui_set_radix -radix {decimal} -signals {Sim:tb_multiplier.ERROR}
gui_set_radix -radix {twosComplement} -signals {Sim:tb_multiplier.ERROR}
...
gui_wv_zoom_timerange -id ${Wave.1} 1825773 1826010
...
gui_marker_move -id ${Wave.1} {C1} 51350000
