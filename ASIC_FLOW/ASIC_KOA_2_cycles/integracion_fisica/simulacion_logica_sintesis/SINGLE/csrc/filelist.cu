...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _29711_archive_1.so
_29711_archive_1.so : archive.7/_29711_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -o .//../simv.daidir//_29711_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_29711_archive_1.so $@
...
VCS_OBJS0 =objs/udps/exIG1.o objs/udps/U7Vwg.o objs/udps/uYEPC.o 
