...
# Created by write_sdc on Sun Nov 20 02:53:53 2016
...
set_input_delay -clock clk  -max 3.5  [get_ports clk]
...
set_output_delay -clock clk  -max 2  [get_ports if_error_delayed]
set_output_delay -clock clk  -min 1  [get_ports if_error_delayed]
set_output_delay -clock clk  -max 2  [get_ports co1]
set_output_delay -clock clk  -min 1  [get_ports co1]
set_output_delay -clock clk  -max 2  [get_ports co2]
set_output_delay -clock clk  -min 1  [get_ports co2]
set_output_delay -clock clk  -max 2  [get_ports co3]
set_output_delay -clock clk  -min 1  [get_ports co3]
