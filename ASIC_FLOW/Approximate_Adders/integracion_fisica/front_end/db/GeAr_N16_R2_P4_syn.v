...
module GeAr_N16_R2_P4 ( in1, in2, res );
  ...
  input [15:0] in2;
  output [16:0] res;
  wire   intadd_6_CI, intadd_6_n4, intadd_6_n3, intadd_6_n2, intadd_6_n1, n2,
         n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n15, n16, n17,
         n18, n19, n20, n21, n22, n23, n24, n25, n26, n27, n28, n29, n30, n31,
         n32, n33, n34, n35, n36, n37, n38, n39, n40, n41, n42;

  CMPR32X2TS intadd_6_U5 ( .A(in2[1]), .B(in1[1]), .C(intadd_6_CI), .CO(
        intadd_6_n4), .S(res[1]) );
  CMPR32X2TS intadd_6_U4 ( .A(in2[2]), .B(in1[2]), .C(intadd_6_n4), .CO(
        intadd_6_n3), .S(res[2]) );
  CMPR32X2TS intadd_6_U3 ( .A(in2[3]), .B(in1[3]), .C(intadd_6_n3), .CO(
        intadd_6_n2), .S(res[3]) );
  CMPR32X2TS intadd_6_U2 ( .A(in2[4]), .B(in1[4]), .C(intadd_6_n2), .CO(
        intadd_6_n1), .S(res[4]) );
  OAI21XLTS U2 ( .A0(n8), .A1(n7), .B0(intadd_6_n1), .Y(n5) );
  ...
  AOI2BB1XLTS U44 ( .A0N(in2[0]), .A1N(in1[0]), .B0(intadd_6_CI), .Y(res[0])
         );
