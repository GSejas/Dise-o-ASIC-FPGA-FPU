...
// Date      : Sun Nov 20 02:18:14 2016
/////////////////////////////////////////////////////////////


module ETAII_N16_Q4 ( in1, in2, res );
  input [15:0] in1;
  input [15:0] in2;
  output [16:0] res;
  ...
  OAI211XLTS U44 ( .A0(in2[11]), .A1(in1[11]), .B0(in2[10]), .C0(in1[10]), .Y(
        n46) );
  CLKAND2X2TS U45 ( .A(in1[0]), .B(in2[0]), .Y(n57) );
  ...
  AOI2BB1XLTS U55 ( .A0N(in1[0]), .A1N(in2[0]), .B0(n57), .Y(res[0]) );
  ...
  CMPR32X2TS U72 ( .A(in1[2]), .B(in2[2]), .C(n56), .CO(n50), .S(res[2]) );
  CMPR32X2TS U73 ( .A(in1[1]), .B(in2[1]), .C(n57), .CO(n56), .S(res[1]) );
...
initial $sdf_annotate("ETAII_N16_Q4_syn.sdf"); 
 endmodule
