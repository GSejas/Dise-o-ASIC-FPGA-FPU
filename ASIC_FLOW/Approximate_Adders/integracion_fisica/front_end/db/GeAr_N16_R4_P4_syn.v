...
// Date      : Sat Nov 19 00:24:52 2016
/////////////////////////////////////////////////////////////


module GeAr_N16_R4_P4_DW01_add_J96_0 ( A, B, CI, SUM, CO );
  input [8:0] A;
  input [8:0] B;
  output [8:0] SUM;
  input CI;
...
module GeAr_N16_R4_P4_DW01_add_J96_1 ( A, B, CI, SUM, CO );
  input [7:0] A;
  input [7:0] B;
  output [7:0] SUM;
  input CI;
...
module GeAr_N16_R4_P4 ( in1, in2, res );
  ...
  GeAr_N16_R4_P4_DW01_add_J96_0 add_x_3 ( .A({1'b0, in1[15:8]}), .B({1'b0, 
        in2[15:8]}), .CI(1'b0), .SUM({res[16:12], SYNOPSYS_UNCONNECTED_1, 
        SYNOPSYS_UNCONNECTED_2, SYNOPSYS_UNCONNECTED_3, SYNOPSYS_UNCONNECTED_4}) );
  GeAr_N16_R4_P4_DW01_add_J96_1 add_x_2 ( .A(in1[11:4]), .B(in2[11:4]), .CI(
