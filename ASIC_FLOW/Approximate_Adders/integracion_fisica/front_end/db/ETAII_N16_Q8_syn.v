...
module ETAII_N16_Q8_DW01_add_J83_0 ( A, B, CI, SUM, CO );
  input [8:0] A;
  input [8:0] B;
  output [8:0] SUM;
  input CI;
...
module ETAII_N16_Q8_DW01_add_J83_1 ( A, B, CI, SUM, CO );
  input [7:0] A;
  input [7:0] B;
  output [7:0] SUM;
  input CI;
...
module ETAII_N16_Q8_DW01_add_J83_2 ( A, B, CI, SUM, CO );
  input [7:0] A;
  input [7:0] B;
  output [7:0] SUM;
  input CI;
...
module ETAII_N16_Q8 ( in1, in2, res );
  ...
  ETAII_N16_Q8_DW01_add_J83_0 add_x_4 ( .A({1'b0, in1[15:8]}), .B({1'b0, 
        in2[15:8]}), .CI(1'b0), .SUM({res[16:12], SYNOPSYS_UNCONNECTED_1, 
        SYNOPSYS_UNCONNECTED_2, SYNOPSYS_UNCONNECTED_3, SYNOPSYS_UNCONNECTED_4}) );
  ETAII_N16_Q8_DW01_add_J83_1 add_x_3 ( .A(in1[11:4]), .B(in2[11:4]), .CI(1'b0), .SUM({res[11:8], SYNOPSYS_UNCONNECTED_5, SYNOPSYS_UNCONNECTED_6, 
        SYNOPSYS_UNCONNECTED_7, SYNOPSYS_UNCONNECTED_8}) );
  ETAII_N16_Q8_DW01_add_J83_2 add_x_2 ( .A(in1[7:0]), .B(in2[7:0]), .CI(1'b0), 
