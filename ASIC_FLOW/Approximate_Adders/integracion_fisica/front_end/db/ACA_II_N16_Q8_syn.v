...
initial $sdf_annotate("ACA_II_N16_Q8_syn.sdf"); 
 endmodule


module ACA_II_N16_Q8_DW01_add_J42_1 ( A, B, CI, SUM, CO );
  input [7:0] A;
  input [7:0] B;
  output [7:0] SUM;
  input CI;
...
module ACA_II_N16_Q8 ( in1, in2, res );
  input [15:0] in1;
  input [15:0] in2;
  output [16:0] res;
  ...
  ACA_II_N16_Q8_DW01_add_J42_0 add_x_3 ( .A({1'b0, in1[15:8]}), .B({1'b0, 
        in2[15:8]}), .CI(1'b0), .SUM({res[16:12], SYNOPSYS_UNCONNECTED_1, 
        SYNOPSYS_UNCONNECTED_2, SYNOPSYS_UNCONNECTED_3, SYNOPSYS_UNCONNECTED_4}) );
  ACA_II_N16_Q8_DW01_add_J42_1 add_x_2 ( .A(in1[11:4]), .B(in2[11:4]), .CI(
