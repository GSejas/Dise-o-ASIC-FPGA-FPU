...
# Created by write_sdc on Sun Nov 20 02:50:37 2016
...
set_input_delay -clock clk  -max 3.5  [get_ports {ctrl[2]}]
set_input_delay -clock clk  -min 1  [get_ports {ctrl[2]}]
set_input_delay -clock clk  -max 3.5  [get_ports {ctrl[1]}]
set_input_delay -clock clk  -min 1  [get_ports {ctrl[1]}]
set_input_delay -clock clk  -max 3.5  [get_ports {ctrl[0]}]
set_input_delay -clock clk  -min 1  [get_ports {ctrl[0]}]
set_input_delay -clock clk  -max 3.5  [get_ports in_ctrl_0]
set_input_delay -clock clk  -min 1  [get_ports in_ctrl_0]
set_input_delay -clock clk  -max 3.5  [get_ports {in_ctrl_1[1]}]
set_input_delay -clock clk  -min 1  [get_ports {in_ctrl_1[1]}]
set_input_delay -clock clk  -max 3.5  [get_ports {in_ctrl_1[0]}]
set_input_delay -clock clk  -min 1  [get_ports {in_ctrl_1[0]}]
set_input_delay -clock clk  -max 3.5  [get_ports {in_ctrl_2[2]}]
set_input_delay -clock clk  -min 1  [get_ports {in_ctrl_2[2]}]
set_input_delay -clock clk  -max 3.5  [get_ports {in_ctrl_2[1]}]
set_input_delay -clock clk  -min 1  [get_ports {in_ctrl_2[1]}]
set_input_delay -clock clk  -max 3.5  [get_ports {in_ctrl_2[0]}]
set_input_delay -clock clk  -min 1  [get_ports {in_ctrl_2[0]}]
