...
module GeAr_N8_R1_P4 ( in1, in2, res );
  ...
  input [7:0] in2;
  output [8:0] res;
  wire   intadd_7_CI, intadd_7_n3, intadd_7_n2, intadd_7_n1, n2, n3, n4, n5,
         n6, n7, n8, n9, n10, n11, n12, n13, n14, n15, n16, n17, n18;

  CMPR32X2TS intadd_7_U4 ( .A(in2[1]), .B(in1[1]), .C(intadd_7_CI), .CO(
        intadd_7_n3), .S(res[1]) );
  CMPR32X2TS intadd_7_U3 ( .A(in2[2]), .B(in1[2]), .C(intadd_7_n3), .CO(
        intadd_7_n2), .S(res[2]) );
  CMPR32X2TS intadd_7_U2 ( .A(in2[3]), .B(in1[3]), .C(intadd_7_n2), .CO(
        intadd_7_n1), .S(res[3]) );
  AO21XLTS U2 ( .A0(n8), .A1(n3), .B0(n9), .Y(n4) );
  CLKAND2X2TS U3 ( .A(in2[0]), .B(in1[0]), .Y(intadd_7_CI) );
  ...
  AOI2BB1XLTS U9 ( .A0N(in2[0]), .A1N(in1[0]), .B0(intadd_7_CI), .Y(res[0]) );
  NOR2X2TS U10 ( .A(in2[4]), .B(in1[4]), .Y(n14) );
  AOI21X1TS U11 ( .A0(in1[4]), .A1(in2[4]), .B0(n14), .Y(n2) );
  XOR2XLTS U12 ( .A(n2), .B(intadd_7_n1), .Y(res[4]) );
