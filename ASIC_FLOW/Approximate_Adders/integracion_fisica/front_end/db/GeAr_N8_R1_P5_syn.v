...
module GeAr_N8_R1_P5 ( in1, in2, res );
  ...
  input [7:0] in2;
  output [8:0] res;
  wire   intadd_8_CI, intadd_8_n4, intadd_8_n3, intadd_8_n2, intadd_8_n1, n2,
         n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n15, n16, n17,
         n18;

  CMPR32X2TS intadd_8_U5 ( .A(in2[1]), .B(in1[1]), .C(intadd_8_CI), .CO(
        intadd_8_n4), .S(res[1]) );
  CMPR32X2TS intadd_8_U4 ( .A(in2[2]), .B(in1[2]), .C(intadd_8_n4), .CO(
        intadd_8_n3), .S(res[2]) );
  CMPR32X2TS intadd_8_U3 ( .A(in2[3]), .B(in1[3]), .C(intadd_8_n3), .CO(
        intadd_8_n2), .S(res[3]) );
  CMPR32X2TS intadd_8_U2 ( .A(in2[4]), .B(in1[4]), .C(intadd_8_n2), .CO(
        intadd_8_n1), .S(res[4]) );
  XOR2XLTS U2 ( .A(in1[6]), .B(in2[6]), .Y(n6) );
  AO22XLTS U3 ( .A0(in2[3]), .A1(in1[3]), .B0(in2[2]), .B1(in1[2]), .Y(n10) );
  CLKAND2X2TS U4 ( .A(in2[1]), .B(in1[1]), .Y(n2) );
  CLKAND2X2TS U5 ( .A(in2[0]), .B(in1[0]), .Y(intadd_8_CI) );
  ...
  AOI2BB1XLTS U14 ( .A0N(in2[0]), .A1N(in1[0]), .B0(intadd_8_CI), .Y(res[0])
         );
  XNOR2X1TS U15 ( .A(intadd_8_n1), .B(n9), .Y(res[5]) );
