...
# DVE full session
# Saved on Thu Oct 27 18:20:48 2016
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_hier_colhier 916} {child_hier_coltype 440} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 422753 910178
gui_list_add_group -id ${Wave.1} -after {New Group} {tb_multiplier}
gui_list_set_height -id ${Wave.1} -height 15 -name tb_multiplier
gui_seek_criteria -id ${Wave.1} {Any Edge}

gui_list_set_height -id ${Wave.1} -height 15  -name Sim:tb_multiplier.load_b_i -occurrence 1 -group ${tb_multiplier} 
gui_list_set_height -id ${Wave.1} -height 15  -name Sim:tb_multiplier.SW -occurrence 1 -group ${tb_multiplier} 
gui_list_set_height -id ${Wave.1} -height 15  -name Sim:tb_multiplier.a -occurrence 1 -group ${tb_multiplier} 
gui_list_set_height -id ${Wave.1} -height 15  -name Sim:tb_multiplier.b -occurrence 1 -group ${tb_multiplier} 
gui_list_set_height -id ${Wave.1} -height 15  -name Sim:tb_multiplier.i -occurrence 1 -group ${tb_multiplier} 
gui_list_set_height -id ${Wave.1} -height 15  -name Sim:tb_multiplier.FKOARES -occurrence 1 -group ${tb_multiplier} 
gui_list_set_height -id ${Wave.1} -height 15  -name Sim:tb_multiplier.clk -occurrence 1 -group ${tb_multiplier} 
gui_list_set_height -id ${Wave.1} -height 15  -name Sim:tb_multiplier.cycles -occurrence 1 -group ${tb_multiplier} 
gui_list_set_height -id ${Wave.1} -height 15  -name Sim:tb_multiplier.rst -occurrence 1 -group ${tb_multiplier} 
...
gui_marker_move -id ${Wave.1} {C1} 625931
