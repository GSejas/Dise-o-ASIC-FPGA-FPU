...
# DVE full session
# Saved on Thu Oct 20 12:35:56 2016
# Designs open: 1
#   Sim: /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/DOUBLE/simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/DOUBLE/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{1364 49} {2724 763}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 422} {child_wave_right 933} {child_wave_colname 239} {child_wave_colvalue 180} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +lint=all -a log_name +define+DOUBLE}}
gui_set_env SIMSETUP::SIMEXE {simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/DOUBLE/simv}] } {
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+DOUBLE -ucligui} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/DOUBLE -nosource
}
}
...
catch {gui_list_select -id ${Hier.1} {Testbench_FPU_Add_Subt.uut.Oper_Start_in_module_MRegister_Q_reg_0_}}
gui_view_scroll -id ${Hier.1} -vertical -set 4513
gui_view_scroll -id ${Hier.1} -horizontal -set 0

# Data 'Data.1'
gui_list_set_filter -id ${Data.1} -list { {Buffer 1} {Input 1} {Others 1} {Linkage 1} {Output 1} {LowPower 1} {Parameter 1} {All 1} {Aggregate 1} {LibBaseMember 1} {Event 1} {Assertion 1} {Constant 1} {Interface 1} {BaseMembers 1} {Signal 1} {$unit 1} {Inout 1} {Variable 1} }
gui_list_set_filter -id ${Data.1} -text {*}
gui_list_show_data -id ${Data.1} {Testbench_FPU_Add_Subt.uut.Oper_Start_in_module_MRegister_Q_reg_0_}
...
gui_open_source -id ${Source.1}  -replace -active Testbench_FPU_Add_Subt /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/DOUBLE/Testbench_FPU_Add_Subt.v
...
gui_wv_zoom_timerange -id ${Wave.1} 0 1359649
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Testbench_FPU_Add_Subt  -item {Testbench_FPU_Add_Subt.final_result_ieee[63:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 3135826
