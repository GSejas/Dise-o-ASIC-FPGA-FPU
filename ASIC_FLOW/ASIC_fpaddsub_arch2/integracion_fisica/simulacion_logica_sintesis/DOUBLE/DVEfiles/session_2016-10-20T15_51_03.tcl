...
# DVE full session
# Saved on Thu Oct 20 15:51:03 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{1365 74} {2724 787}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 422} {child_wave_right 932} {child_wave_colname 239} {child_wave_colvalue 180} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_view_scroll -id ${Hier.1} -vertical -set 6564
...
gui_wv_zoom_timerange -id ${Wave.1} 6082645 6762470
...
gui_marker_move -id ${Wave.1} {C1} 6389759
gui_view_scroll -id ${Wave.1} -vertical -set 70
