...
# DVE full session
# Saved on Thu Oct 20 16:00:49 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{1367 47} {2724 758}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 421} {child_wave_right 931} {child_wave_colname 239} {child_wave_colvalue 180} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 1450693 2130519
...
gui_marker_move -id ${Wave.1} {C1} 1790980
gui_view_scroll -id ${Wave.1} -vertical -set 24
