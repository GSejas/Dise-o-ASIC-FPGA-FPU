...
# DVE full session
# Saved on Thu Oct 20 16:03:02 2016
# Designs open: 1
#   Sim: simv
...
#   Wave.1: 13 signals
#   Group count = 1
#   Group Testbench_FPU_Add_Subt signal count = 13
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/DOUBLE/session.inter.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{1368 72} {2724 782}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 421} {child_wave_right 930} {child_wave_colname 239} {child_wave_colvalue 180} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+DOUBLE -ucligui} -dir ../DOUBLE -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 622592
gui_list_add_group -id ${Wave.1} -after {New Group} {Testbench_FPU_Add_Subt}
gui_list_select -id ${Wave.1} {Testbench_FPU_Add_Subt.ack_FSM }
