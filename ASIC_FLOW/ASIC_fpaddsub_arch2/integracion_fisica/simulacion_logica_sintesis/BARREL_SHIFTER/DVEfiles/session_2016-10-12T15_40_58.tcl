...
# DVE full session
# Saved on Wed Oct 12 15:40:58 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{0 52} {1356 765}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 168]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 168
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 414
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 167} {height 415} {dock_state left} {dock_on_new_line true} {child_hier_colhier 159} {child_hier_coltype 10} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 168]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 168
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 414
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 167} {height 415} {dock_state left} {dock_on_new_line true} {child_data_colvariable 146} {child_data_colvalue 10} {child_data_coltype 10} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1356} {height 172} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 323} {child_wave_right 692} {child_wave_colname 159} {child_wave_colvalue 160} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_open_source -id ${Source.1}  -replace -active Testbench_Barrel_Shifter /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/BARREL_SHIFTER/Testbench_DW_Barrel2.v
gui_view_scroll -id ${Source.1} -vertical -set 308
...
gui_wv_zoom_timerange -id ${Wave.1} 0 232476
...
gui_marker_move -id ${Wave.1} {C1} 61000
