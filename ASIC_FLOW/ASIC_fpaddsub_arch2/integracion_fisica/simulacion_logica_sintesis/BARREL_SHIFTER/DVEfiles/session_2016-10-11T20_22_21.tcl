...
# DVE full session
# Saved on Tue Oct 11 20:22:21 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{2 79} {1017 762}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 196]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 196
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 364
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 195} {height 364} {dock_state left} {dock_on_new_line true} {child_hier_colhier 185} {child_hier_coltype 67} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 163]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1016
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 163
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1015} {height 162} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${DLPane.1} -show_state normal -rect {{0 0} {371 305}}
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 376} {height 335} {show_state normal} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 188} {child_data_colvalue 114} {child_data_coltype 54} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Source.1 [gui_create_window -type {Source}  -parent ${TopLevel.1}]
gui_show_window -window ${Source.1} -show_state minimized -rect {{0 0} {359 269}}
gui_update_layout -id ${Source.1} {{left 375} {top 0} {width 364} {height 299} {show_state minimized} {dock_state undocked} {dock_on_new_line false}}
