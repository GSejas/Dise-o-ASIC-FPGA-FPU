...
# DVE full session
# Saved on Tue Oct 11 17:19:45 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{2 79} {1018 763}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 196} {height 364} {dock_state left} {dock_on_new_line true} {child_hier_colhier 185} {child_hier_coltype 67} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1016} {height 163} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${DLPane.1} -show_state normal -rect {{0 0} {367 305}}
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 372} {height 335} {show_state normal} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 188} {child_data_colvalue 114} {child_data_coltype 54} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Source.1 [gui_create_window -type {Source}  -parent ${TopLevel.1}]
gui_show_window -window ${Source.1} -show_state minimized -rect {{0 0} {359 269}}
gui_update_layout -id ${Source.1} {{left 371} {top 0} {width 364} {height 299} {show_state minimized} {dock_state undocked} {dock_on_new_line false}}
