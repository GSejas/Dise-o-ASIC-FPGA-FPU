...
# DVE full session
# Saved on Tue Oct 18 20:14:28 2016
# Designs open: 1
...
catch {gui_list_select -id ${Hier.1} {Comparator_W31}}
...
gui_list_show_data -id ${Data.1} {Comparator_W31}
...
gui_open_source -id ${Source.1}  -replace -active Comparator_W31 /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/SINGLE/../../front_end/db/SINGLE/FPU_Add_Subtract_Function_syn.v
gui_view_scroll -id ${Source.1} -vertical -set 392
