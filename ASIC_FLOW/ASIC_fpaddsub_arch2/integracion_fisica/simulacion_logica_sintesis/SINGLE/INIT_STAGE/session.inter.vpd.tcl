...
# DVE full session
# Saved on Mon Oct 17 16:07:59 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/SINGLE/INIT_STAGE/session.inter.vpd.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_hier_colhier 644} {child_hier_coltype 370} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 484} {child_wave_right 529} {child_wave_colname 267} {child_wave_colvalue 212} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SYN_SINGLE -ucligui} -dir ../INIT_STAGE -nosource
}
}
...
set _session_group_1 tb_Oper_Start_In
gui_sg_create "$_session_group_1"
set tb_Oper_Start_In "$_session_group_1"

gui_sg_addsignal -group "$_session_group_1" { tb_Oper_Start_In.Array_IN tb_Oper_Start_In.Array_IN_2 tb_Oper_Start_In.DMP_o tb_Oper_Start_In.DmP_o tb_Oper_Start_In.Data_X_i tb_Oper_Start_In.Data_Y_i tb_Oper_Start_In.PERIOD tb_Oper_Start_In.W tb_Oper_Start_In.add_subt_i tb_Oper_Start_In.clk tb_Oper_Start_In.contador tb_Oper_Start_In.load_a_i tb_Oper_Start_In.load_b_i tb_Oper_Start_In.real_op_o tb_Oper_Start_In.rst tb_Oper_Start_In.sign_final_result_o tb_Oper_Start_In.zero_flag_o }
gui_set_radix -radix {oct} -signals {Sim:tb_Oper_Start_In.DMP_o}
...
gui_open_source -id ${Source.1}  -replace -active tb_Oper_Start_In tb_Oper_Start_In.v
...
gui_wv_zoom_timerange -id ${Wave.1} 1878501 2078492
gui_list_add_group -id ${Wave.1} -after {New Group} {tb_Oper_Start_In}
gui_list_select -id ${Wave.1} {tb_Oper_Start_In.Data_X_i tb_Oper_Start_In.Data_Y_i }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group tb_Oper_Start_In  -item {tb_Oper_Start_In.DmP_o[30:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 1912684
gui_view_scroll -id ${Wave.1} -vertical -set 21
