...
# DVE full session
# Saved on Mon Oct 17 20:13:15 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{9 55} {970 738}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 459} {child_wave_right 497} {child_wave_colname 253} {child_wave_colvalue 202} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 85430 335430
...
gui_marker_move -id ${Wave.1} {C1} 179245
