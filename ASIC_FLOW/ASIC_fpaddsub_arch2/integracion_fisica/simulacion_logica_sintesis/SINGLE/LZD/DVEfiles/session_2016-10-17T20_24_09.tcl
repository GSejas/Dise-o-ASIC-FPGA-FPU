...
# DVE full session
# Saved on Mon Oct 17 20:24:09 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{11 56} {971 738}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 459} {child_wave_right 496} {child_wave_colname 253} {child_wave_colvalue 202} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_load_child_values {tb_LZD.inst_LZD}


set _session_group_1 inst_LZD
gui_sg_create "$_session_group_1"
set inst_LZD "$_session_group_1"

gui_sg_addsignal -group "$_session_group_1" { tb_LZD.inst_LZD.load_i tb_LZD.inst_LZD.Shift_Value_o tb_LZD.inst_LZD.Add_subt_result_i tb_LZD.inst_LZD.clk tb_LZD.inst_LZD.Codec_to_Reg tb_LZD.inst_LZD.rst }
...
# Restore C1 time
gui_set_time -C1_only 415724925000
...
catch {gui_list_expand -id ${Hier.1} tb_LZD}
catch {gui_list_select -id ${Hier.1} {tb_LZD.inst_LZD}}
...
gui_list_show_data -id ${Data.1} {tb_LZD.inst_LZD}
...
gui_wv_zoom_timerange -id ${Wave.1} 415724924921 415724925080
gui_list_add_group -id ${Wave.1} -after {New Group} {inst_LZD}
...
gui_list_set_insertion_bar  -id ${Wave.1} -group inst_LZD  -position in

gui_marker_move -id ${Wave.1} {C1} 415724925000
