...
# DVE full session
# Saved on Mon Oct 17 16:38:29 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/SINGLE/LZD/session.inter.vpd.tcl" type="Debug">
...
gui_set_toolbar_attributes -toolbar {Simulator} -offset 2
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 485} {child_wave_right 528} {child_wave_colname 268} {child_wave_colvalue 213} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SYN_SINGLE -ucligui} -dir ../LZD -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active tb_LZD tb_LZD.v
...
gui_wv_zoom_timerange -id ${Wave.1} 50369 1329746
gui_list_add_group -id ${Wave.1} -after {New Group} {tb_LZD}
gui_list_select -id ${Wave.1} {tb_LZD.load_i }
...
gui_marker_move -id ${Wave.1} {C1} 54776
