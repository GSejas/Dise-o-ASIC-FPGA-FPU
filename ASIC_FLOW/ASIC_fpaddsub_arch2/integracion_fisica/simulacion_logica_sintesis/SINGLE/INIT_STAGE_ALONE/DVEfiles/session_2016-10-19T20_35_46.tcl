...
# DVE full session
# Saved on Wed Oct 19 20:35:46 2016
# Designs open: 1
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 424} {child_wave_right 936} {child_wave_colname 239} {child_wave_colvalue 181} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SYN_SINGLE -ucligui} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/SINGLE/INIT_STAGE_ALONE -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active tb_Oper_Start_In /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/SINGLE/INIT_STAGE_ALONE/tb_Oper_Start_In.v
...
gui_wv_zoom_timerange -id ${Wave.1} 161984 1083584
gui_list_add_group -id ${Wave.1} -after {New Group} {tb_Oper_Start_In}
gui_list_select -id ${Wave.1} {tb_Oper_Start_In.real_op_o }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group tb_Oper_Start_In  -position in

gui_marker_move -id ${Wave.1} {C1} 185944
