...
# DVE full session
# Saved on Tue Oct 18 16:50:58 2016
# Designs open: 1
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 650} {child_wave_right 710} {child_wave_colname 350} {child_wave_colvalue 296} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMARGS {{ +v2k +lint=all -l log_name +define+SYN_SINGLE -ucligui}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -l log_name +define+SYN_SINGLE -ucligui} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_sintesis/SINGLE/INIT_STAGE -nosource
}
}
...
# Restore C1 time
gui_set_time -C1_only 102395000
...
gui_marker_create -id ${Wave.1} M1 136000
gui_marker_create -id ${Wave.1} M2 135000
gui_marker_set_ref -id ${Wave.1}  C1
gui_wv_zoom_timerange -id ${Wave.1} 102369995 102420211
...
gui_marker_move -id ${Wave.1} {C1} 102395000
