...
# Saved on Wed Oct 12 17:30:08 2016
...
#<Session mode="View" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_behavioral/BARREL_SHIFTER/session3.inter.vpd.tcl" type="Debug">
...
set _wave_session_group_7 Testbench_Barrel_Shifter
...
gui_sg_addsignal -group "$_wave_session_group_7" { {Sim:Testbench_Barrel_Shifter.Bit_Shift_i} {Sim:Testbench_Barrel_Shifter.Contador_shiftvalue} {Sim:Testbench_Barrel_Shifter.Data_arrayHW} {Sim:Testbench_Barrel_Shifter.Data_array} {Sim:Testbench_Barrel_Shifter.Shift_Value_i} {Sim:Testbench_Barrel_Shifter.EWR} {Sim:Testbench_Barrel_Shifter.Left_Right_i} {Sim:Testbench_Barrel_Shifter.N_mant_o} {Sim:Testbench_Barrel_Shifter.PERIOD} {Sim:Testbench_Barrel_Shifter.SWR} {Sim:Testbench_Barrel_Shifter.Shift_Data_i} {Sim:Testbench_Barrel_Shifter.clk} {Sim:Testbench_Barrel_Shifter.load_i} {Sim:Testbench_Barrel_Shifter.rst} }
...
gui_set_radix -radix {binary} -signals {Sim:Testbench_Barrel_Shifter.Shift_Value_i}
...
set _wave_session_group_8 shift_mux_array1
...
set _wave_session_group_9 shift_mux_array2
...
set _wave_session_group_10 shift_mux_array3
...
set _wave_session_group_11 shift_mux_array4
...
set _wave_session_group_12 shift_mux_array5
...
gui_wv_zoom_timerange -id ${Wave.1} 612022 1892023
...
gui_list_expand -id ${Wave.1} Testbench_Barrel_Shifter.Data_arrayHW
gui_list_select -id ${Wave.1} {Testbench_Barrel_Shifter.Shift_Value_i }
gui_set_radix -radix binary -signal {{Testbench_Barrel_Shifter.Data_arrayHW[6]}}
gui_set_radix -radix binary -signal {{Testbench_Barrel_Shifter.Data_arrayHW[5]}}
gui_set_radix -radix binary -signal {{Testbench_Barrel_Shifter.Data_arrayHW[4]}}
gui_set_radix -radix binary -signal {{Testbench_Barrel_Shifter.Data_arrayHW[3]}}
gui_set_radix -radix binary -signal {{Testbench_Barrel_Shifter.Data_arrayHW[2]}}
gui_set_radix -radix binary -signal {{Testbench_Barrel_Shifter.Data_arrayHW[1]}}
gui_set_radix -radix binary -signal {{Testbench_Barrel_Shifter.Data_arrayHW[0]}}
...
gui_list_set_insertion_bar  -id ${Wave.1} -group ${Group1}  -item {Testbench_Barrel_Shifter.Shift_Value_i[4:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 954755
