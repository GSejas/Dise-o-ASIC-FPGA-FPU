...
# DVE full session
# Saved on Thu Oct 20 15:57:51 2016
# Designs open: 1
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_behavioral/DOUBLE/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{1361 75} {2724 792}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 423} {child_wave_right 935} {child_wave_colname 239} {child_wave_colvalue 180} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +lint=all -a log_name +define+DOUBLE +define+FRANCIS_LZD=1}}
gui_set_env SIMSETUP::SIMEXE {simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_behavioral/DOUBLE/simv}] } {
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+DOUBLE +define+FRANCIS_LZD=1 -ucligui} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_behavioral/DOUBLE -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 713414 1759526
gui_list_add_group -id ${Wave.1} -after {New Group} {Testbench_FPU_Add_Subt}
gui_list_select -id ${Wave.1} {Testbench_FPU_Add_Subt.final_result_ieee Testbench_FPU_Add_Subt.Data_X Testbench_FPU_Add_Subt.Data_Y }
...
gui_marker_move -id ${Wave.1} {C1} 1447407
gui_view_scroll -id ${Wave.1} -vertical -set 18
