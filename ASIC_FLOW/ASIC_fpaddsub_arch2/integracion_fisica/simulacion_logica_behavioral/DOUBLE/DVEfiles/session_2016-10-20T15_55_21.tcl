...
# DVE full session
# Saved on Thu Oct 20 15:55:21 2016
# Designs open: 1
...
gui_wv_zoom_timerange -id ${Wave.1} 0 2490369
...
gui_marker_move -id ${Wave.1} {C1} 1111966
gui_view_scroll -id ${Wave.1} -vertical -set 33
