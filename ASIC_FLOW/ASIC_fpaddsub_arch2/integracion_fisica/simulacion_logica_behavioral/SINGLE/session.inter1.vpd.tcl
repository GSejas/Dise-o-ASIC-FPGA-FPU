...
# DVE full session
# Saved on Wed Oct 12 18:53:10 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_behavioral/SINGLE/session.inter1.vpd.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_hier_colhier 761} {child_hier_coltype 594} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 175} {child_data_colvalue 12} {child_data_coltype 51} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Source.1 [gui_create_window -type {Source}  -parent ${TopLevel.1}]
gui_show_window -window ${Source.1} -show_state maximized
gui_update_layout -id ${Source.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false}}
set Wave.1 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.1} -show_state maximized
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 510} {child_wave_right 844} {child_wave_colname 270} {child_wave_colvalue 235} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SINGLE -ucligui} -dir ../SINGLE -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_9" { Testbench_FPU_Add_Subt.uut.A_S_C Testbench_FPU_Add_Subt.uut.A_S_P Testbench_FPU_Add_Subt.uut.Add_Sub_Sgf_Oper_A_D1 Testbench_FPU_Add_Subt.uut.Add_Subt_LZD Testbench_FPU_Add_Subt.uut.Add_Subt_result Testbench_FPU_Add_Subt.uut.Barrel_Shifter_S_V_D2 Testbench_FPU_Add_Subt.uut.DMP Testbench_FPU_Add_Subt.uut.Data_X Testbench_FPU_Add_Subt.uut.Data_Y Testbench_FPU_Add_Subt.uut.DmP Testbench_FPU_Add_Subt.uut.EWR Testbench_FPU_Add_Subt.uut.EW Testbench_FPU_Add_Subt.uut.Exp_oper_B_D1 Testbench_FPU_Add_Subt.uut.Exp_oper_B_D2 Testbench_FPU_Add_Subt.uut.FSM_Add_Subt_Sgf_load Testbench_FPU_Add_Subt.uut.FSM_Final_Result_load Testbench_FPU_Add_Subt.uut.FSM_LZA_load Testbench_FPU_Add_Subt.uut.FSM_barrel_shifter_B_S Testbench_FPU_Add_Subt.uut.FSM_barrel_shifter_L_R Testbench_FPU_Add_Subt.uut.FSM_exp_operation_A_S Testbench_FPU_Add_Subt.uut.FSM_exp_operation_load_OU Testbench_FPU_Add_Subt.uut.FSM_exp_operation_load_diff Testbench_FPU_Add_Subt.uut.FSM_op_start_in_load_a Testbench_FPU_Add_Subt.uut.FSM_op_start_in_load_b Testbench_FPU_Add_Subt.uut.FSM_selector_A Testbench_FPU_Add_Subt.uut.FSM_selector_B Testbench_FPU_Add_Subt.uut.FSM_selector_C Testbench_FPU_Add_Subt.uut.FSM_selector_D Testbench_FPU_Add_Subt.uut.LZA_output Testbench_FPU_Add_Subt.uut.S_A_S_Oper_A Testbench_FPU_Add_Subt.uut.S_A_S_Oper_B Testbench_FPU_Add_Subt.uut.S_A_S_op Testbench_FPU_Add_Subt.uut.S_Data_Shift Testbench_FPU_Add_Subt.uut.S_Oper_A_exp Testbench_FPU_Add_Subt.uut.S_Oper_B_exp Testbench_FPU_Add_Subt.uut.S_Shift_Value Testbench_FPU_Add_Subt.uut.clk Testbench_FPU_Add_Subt.uut.Sgf_normalized_result Testbench_FPU_Add_Subt.uut.W Testbench_FPU_Add_Subt.uut.ack_FSM Testbench_FPU_Add_Subt.uut.add_overflow_flag Testbench_FPU_Add_Subt.uut.add_subt Testbench_FPU_Add_Subt.uut.beg_FSM Testbench_FPU_Add_Subt.uut.clk Testbench_FPU_Add_Subt.uut.exp_oper_result Testbench_FPU_Add_Subt.uut.final_result_ieee Testbench_FPU_Add_Subt.uut.load_b Testbench_FPU_Add_Subt.uut.overflow_flag Testbench_FPU_Add_Subt.uut.r_mode Testbench_FPU_Add_Subt.uut.ready Testbench_FPU_Add_Subt.uut.real_op Testbench_FPU_Add_Subt.uut.round_flag Testbench_FPU_Add_Subt.uut.rst Testbench_FPU_Add_Subt.uut.rst_int Testbench_FPU_Add_Subt.uut.selector_A Testbench_FPU_Add_Subt.uut.selector_B Testbench_FPU_Add_Subt.uut.selector_C Testbench_FPU_Add_Subt.uut.selector_D Testbench_FPU_Add_Subt.uut.sign_final_result Testbench_FPU_Add_Subt.uut.underflow_flag Testbench_FPU_Add_Subt.uut.zero_flag }
gui_sg_addsignal -group "$_session_group_9" { Divider } -divider
gui_sg_addsignal -group "$_session_group_9" { Testbench_FPU_Add_Subt.uut.FSM_selector_D Testbench_FPU_Add_Subt.uut.S_Shift_Value Testbench_FPU_Add_Subt.uut.FSM_barrel_shifter_load Testbench_FPU_Add_Subt.uut.S_Data_Shift Testbench_FPU_Add_Subt.uut.clk Testbench_FPU_Add_Subt.uut.Sgf_normalized_result Testbench_FPU_Add_Subt.uut.S_A_S_Oper_A Testbench_FPU_Add_Subt.uut.S_A_S_Oper_B Testbench_FPU_Add_Subt.uut.Add_Subt_result Testbench_FPU_Add_Subt.uut.FSM_selector_C Testbench_FPU_Add_Subt.uut.Add_Subt_result Testbench_FPU_Add_Subt.uut.DmP Testbench_FPU_Add_Subt.uut.S_Data_Shift }
gui_sg_addsignal -group "$_session_group_9" { Divider } -divider
...
catch {gui_list_select -id ${Hier.1} {Testbench_FPU_Add_Subt}}
...
gui_open_source -id ${Source.1}  -replace -active Testbench_FPU_Add_Subt Testbench_FPU_Add_Subt.v
...
gui_wv_zoom_timerange -id ${Wave.1} 110130 369408
...
gui_list_select -id ${Wave.1} {Testbench_FPU_Add_Subt.uut.FSM_barrel_shifter_load }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group8  -item Testbench_FPU_Add_Subt.uut.FSM_barrel_shifter_load -position below

gui_marker_move -id ${Wave.1} {C1} 195000
gui_view_scroll -id ${Wave.1} -vertical -set 1665
