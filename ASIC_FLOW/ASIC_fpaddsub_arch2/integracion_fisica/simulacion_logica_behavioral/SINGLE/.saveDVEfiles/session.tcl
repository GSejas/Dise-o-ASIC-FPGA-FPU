...
# DVE full session
# Saved on Wed Oct 12 18:25:53 2016
# Designs open: 1
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 188} {height 438} {dock_state left} {dock_on_new_line true} {child_data_colvariable 138} {child_data_colvalue 12} {child_data_coltype 13} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 95
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 188} {height 438} {dock_state left} {dock_on_new_line true} {child_hier_colhier 177} {child_hier_coltype 10} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 217} {child_wave_right 156} {child_wave_colname 84} {child_wave_colvalue 129} {child_wave_col1 0} {child_wave_col2 1}}
set Wave.2 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.2} -show_state maximized
gui_update_layout -id ${Wave.2} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 567} {child_wave_right 409} {child_wave_colname 315} {child_wave_colvalue 248} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SINGLE -ucligui} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_behavioral/SINGLE -nosource
}
}
...
catch { gui_list_select -id ${Data.1} {Testbench_FPU_Add_Subt.W }}
gui_view_scroll -id ${Data.1} -vertical -set 190
...
gui_wv_zoom_timerange -id ${Wave.1} 0 54720
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group8  -item {Testbench_FPU_Add_Subt.uut.S_Shift_Value[4:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 10395000
gui_view_scroll -id ${Wave.1} -vertical -set 1817
...
gui_wv_zoom_timerange -id ${Wave.2} 0 129
...
gui_marker_move -id ${Wave.2} {C1} 10395000
