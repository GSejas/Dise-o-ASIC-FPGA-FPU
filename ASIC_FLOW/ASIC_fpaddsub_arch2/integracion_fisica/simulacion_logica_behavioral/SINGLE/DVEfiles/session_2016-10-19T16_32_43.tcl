...
# DVE full session
# Saved on Wed Oct 19 16:32:43 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{1379 49} {2724 748}}
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +lint=all -a log_name +define+SINGLE=1 +define+FRANCIS_LZD=1}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SINGLE=1 +define+FRANCIS_LZD=1 -ucligui} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch2/integracion_fisica/simulacion_logica_behavioral/SINGLE -nosource
}
}
