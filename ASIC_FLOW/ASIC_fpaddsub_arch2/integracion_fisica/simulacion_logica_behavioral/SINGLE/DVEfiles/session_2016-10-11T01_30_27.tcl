...
# DVE full session
# Saved on Tue Oct 11 01:30:27 2016
# Designs open: 1
...
#   Group count = 1
#   Group Testbench_FPU_Add_Subt signal count = 15
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 228]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 228
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 227} {height 397} {dock_state left} {dock_on_new_line true} {child_hier_colhier 185} {child_hier_coltype 67} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 449
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 239} {height 397} {dock_state left} {dock_on_new_line true} {child_data_colvariable 173} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1019} {height 167} {dock_state bottom} {dock_on_new_line true}}
...
set _session_group_2 Testbench_FPU_Add_Subt
gui_sg_create "$_session_group_2"
set Testbench_FPU_Add_Subt "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { Testbench_FPU_Add_Subt.contador Testbench_FPU_Add_Subt.underflow_flag Testbench_FPU_Add_Subt.overflow_flag Testbench_FPU_Add_Subt.ready Testbench_FPU_Add_Subt.ack_FSM Testbench_FPU_Add_Subt.add_subt Testbench_FPU_Add_Subt.beg_FSM Testbench_FPU_Add_Subt.final_result_ieee Testbench_FPU_Add_Subt.clk Testbench_FPU_Add_Subt.Data_X Testbench_FPU_Add_Subt.Data_Y Testbench_FPU_Add_Subt.r_mode Testbench_FPU_Add_Subt.Recept Testbench_FPU_Add_Subt.Cont_CLK Testbench_FPU_Add_Subt.rst }
...
gui_view_scroll -id ${Data.1} -vertical -set 1
