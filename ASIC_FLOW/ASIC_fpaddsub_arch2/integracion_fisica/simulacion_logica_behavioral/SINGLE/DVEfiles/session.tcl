...
# DVE full session
# Saved on Mon Oct 10 00:53:59 2016
# Designs open: 1
...
#   Wave.1: 15 signals
#   Group count = 1
#   Group Testbench_FPU_Add_Subt signal count = 16
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{58 51} {1081 742}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 296} {child_wave_right 722} {child_wave_colname 155} {child_wave_colvalue 137} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Testbench_FPU_Add_Subt  -item Testbench_FPU_Add_Subt.overflow_flag -position below

gui_marker_move -id ${Wave.1} {C1} 755000
