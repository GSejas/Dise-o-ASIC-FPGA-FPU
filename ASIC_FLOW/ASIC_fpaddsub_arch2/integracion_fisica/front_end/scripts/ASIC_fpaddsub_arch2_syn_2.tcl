...
./db/$PRECISION($x)/$DESIGN_NAME\_syn_unmapped.ddc
...
./db/$PRECISION($x)/$DESIGN_NAME\_syn.v
...
report_area >   reports/$PRECISION($x)/$DESIGN_NAME\_syn_area.txt
report_cell >   reports/$PRECISION($x)/$DESIGN_NAME\_syn_cell.txt
report_qor >    reports/$PRECISION($x)/$DESIGN_NAME\_syn_qor.txt
report_timing > reports/$PRECISION($x)/$DESIGN_NAME\_syn_timing.txt
report_port >   reports/$PRECISION($x)/$DESIGN_NAME\_syn_port.txt

#Escribir el archivo *.ddc (base de datos sintetizada)
write -hierarchy -format ddc -output \
./db/$PRECISION($x)/$DESIGN_NAME\_syn_mapped.ddc
...
write_sdc ./db/$PRECISION($x)/$DESIGN_NAME\_syn.sdc
