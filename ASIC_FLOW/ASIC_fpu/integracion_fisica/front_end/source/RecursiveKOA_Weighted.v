...
//  Last Modified : 2016-10-28 08:46:19
//  Revision      : 
//  Author        : Jorge Esteban Sequeira Rojas
//  Company       : Instituto Tecnologico de Costa Rica
//  Email         : jsequeira03@gmail.com
...
generate
    ...
    case (SW%2)
        0:begin : EVEN1
          ...
          submidRecursiveKOA #(.SW(SW/2)) left(
                .clk(clk),
          ...
          submidRecursiveKOA #(.SW(SW/2)) right(
                .clk(clk),
...
`ifdef Segmentation1
          submidRecursiveKOA #(.SW((SW/2)+1)) middle (
`endif 
`ifdef Segmentation2
          submidRecursiveKOA2 #(.SW((SW/2)+1)) middle (
`endif 
                .clk(clk),
    ...
    1:begin : ODD1
          ...
          submidRecursiveKOA #(.SW((SW/2)+1)) right(
                .clk(clk),
                .Data_A_i(Data_A_i[SW-SW/2-1:0]),
                .Data_B_i(Data_B_i[SW-SW/2-1:0]),
                .Data_S_o(Q_right)
...
`ifdef Segmentation1
          submidRecursiveKOA #(.SW(SW/2+2)) middle (
`endif
`ifdef Segmentation2
          submidRecursiveKOA2 #(.SW(SW/2+2)) middle (
`endif       
                .clk(clk),
                .Data_A_i(result_A_adder),
                .Data_B_i(result_B_adder),
