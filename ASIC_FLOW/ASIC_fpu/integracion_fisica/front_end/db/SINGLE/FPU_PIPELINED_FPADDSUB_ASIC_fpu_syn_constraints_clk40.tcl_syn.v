...
module FPU_PIPELINED_FPADDSUB_W32_EW8_SW23_SWR26_EWR5 ( clk, rst, beg_OP, 
  ...
  wire   Shift_reg_FLAGS_7_6, intAS, SIGN_FLAG_EXP, OP_FLAG_EXP, ZERO_FLAG_EXP,
         ...
         DP_OP_15J69_122_6956_n18, DP_OP_15J69_122_6956_n17,
         DP_OP_15J69_122_6956_n16, DP_OP_15J69_122_6956_n15,
         DP_OP_15J69_122_6956_n14, DP_OP_15J69_122_6956_n8,
         DP_OP_15J69_122_6956_n7, DP_OP_15J69_122_6956_n6,
         DP_OP_15J69_122_6956_n5, DP_OP_15J69_122_6956_n4,
         DP_OP_15J69_122_6956_n3, DP_OP_15J69_122_6956_n2,
         DP_OP_15J69_122_6956_n1, n956, n957, n958, n960, n961, n962, n963,
  ...
  ADDFX1TS DP_OP_15J69_122_6956_U9 ( .A(DMP_exp_NRM2_EW[0]), .B(n1732), .CI(
        DP_OP_15J69_122_6956_n18), .CO(DP_OP_15J69_122_6956_n8), .S(
        exp_rslt_NRM2_EW1[0]) );
  ADDFX1TS DP_OP_15J69_122_6956_U8 ( .A(DP_OP_15J69_122_6956_n17), .B(
        DMP_exp_NRM2_EW[1]), .CI(DP_OP_15J69_122_6956_n8), .CO(
        DP_OP_15J69_122_6956_n7), .S(exp_rslt_NRM2_EW1[1]) );
  ADDFX1TS DP_OP_15J69_122_6956_U7 ( .A(DP_OP_15J69_122_6956_n16), .B(
        DMP_exp_NRM2_EW[2]), .CI(DP_OP_15J69_122_6956_n7), .CO(
        DP_OP_15J69_122_6956_n6), .S(exp_rslt_NRM2_EW1[2]) );
  ADDFX1TS DP_OP_15J69_122_6956_U6 ( .A(DP_OP_15J69_122_6956_n15), .B(
        DMP_exp_NRM2_EW[3]), .CI(DP_OP_15J69_122_6956_n6), .CO(
        DP_OP_15J69_122_6956_n5), .S(exp_rslt_NRM2_EW1[3]) );
  ADDFX1TS DP_OP_15J69_122_6956_U4 ( .A(n1732), .B(DMP_exp_NRM2_EW[5]), .CI(
        DP_OP_15J69_122_6956_n4), .CO(DP_OP_15J69_122_6956_n3), .S(
        exp_rslt_NRM2_EW1[5]) );
  DFFRX4TS inst_ShiftRegister_Q_reg_1_ ( .D(n945), .CK(clk), .RN(n1825), .Q(
        Shift_reg_FLAGS_7[1]), .QN(n1000) );
  CMPR32X2TS DP_OP_15J69_122_6956_U5 ( .A(DP_OP_15J69_122_6956_n14), .B(
        DMP_exp_NRM2_EW[4]), .C(DP_OP_15J69_122_6956_n5), .CO(
        DP_OP_15J69_122_6956_n4), .S(exp_rslt_NRM2_EW1[4]) );
  DFFRX4TS inst_ShiftRegister_Q_reg_4_ ( .D(n948), .CK(clk), .RN(n1826), .Q(
        busy), .QN(n1823) );
  CMPR32X2TS DP_OP_15J69_122_6956_U3 ( .A(n1732), .B(DMP_exp_NRM2_EW[6]), .C(
        DP_OP_15J69_122_6956_n3), .CO(DP_OP_15J69_122_6956_n2), .S(
        exp_rslt_NRM2_EW1[6]) );
  CMPR32X2TS DP_OP_15J69_122_6956_U2 ( .A(n1732), .B(DMP_exp_NRM2_EW[7]), .C(
        DP_OP_15J69_122_6956_n2), .CO(DP_OP_15J69_122_6956_n1), .S(
        exp_rslt_NRM2_EW1[7]) );
  ...
  XOR2X1TS U1546 ( .A(n1732), .B(n1337), .Y(DP_OP_15J69_122_6956_n14) );
  NOR2BX1TS U1547 ( .AN(LZD_output_NRM2_EW[3]), .B(ADD_OVRFLW_NRM2), .Y(n1338)
         );
  XOR2X1TS U1548 ( .A(n1732), .B(n1338), .Y(DP_OP_15J69_122_6956_n15) );
  NOR2BX1TS U1549 ( .AN(LZD_output_NRM2_EW[2]), .B(ADD_OVRFLW_NRM2), .Y(n1339)
         );
  XOR2X1TS U1550 ( .A(n1732), .B(n1339), .Y(DP_OP_15J69_122_6956_n16) );
  NOR2BX1TS U1551 ( .AN(LZD_output_NRM2_EW[1]), .B(ADD_OVRFLW_NRM2), .Y(n1340)
         );
  XOR2X1TS U1552 ( .A(n1732), .B(n1340), .Y(DP_OP_15J69_122_6956_n17) );
  OR2X1TS U1553 ( .A(LZD_output_NRM2_EW[0]), .B(ADD_OVRFLW_NRM2), .Y(n1341) );
  XOR2X1TS U1554 ( .A(n1732), .B(n1341), .Y(DP_OP_15J69_122_6956_n18) );
  ...
  XNOR2X1TS U1565 ( .A(DP_OP_15J69_122_6956_n1), .B(ADD_OVRFLW_NRM2), .Y(n1355) );
