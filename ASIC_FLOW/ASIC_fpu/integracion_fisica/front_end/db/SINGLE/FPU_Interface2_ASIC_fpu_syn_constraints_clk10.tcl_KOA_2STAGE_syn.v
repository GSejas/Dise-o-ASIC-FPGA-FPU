...
module FPU_Interface2_W32_EW8_SW23_SWR26_EWR5 ( clk, rst, begin_operation, 
  ...
  wire   n6077, NaN_reg, ready_add_subt, underflow_flag_mult,
         ...
         DP_OP_234J16_127_8543_n1, intadd_55_CI, intadd_55_SUM_2_,
         intadd_55_SUM_1_, intadd_55_SUM_0_, intadd_55_n3, intadd_55_n2,
         intadd_55_n1, intadd_56_CI, intadd_56_SUM_2_, intadd_56_SUM_1_,
         intadd_56_SUM_0_, intadd_56_n3, intadd_56_n2, intadd_56_n1,
  ...
  CMPR32X2TS intadd_55_U4 ( .A(FPSENCOS_d_ff2_Y[24]), .B(n5844), .C(
        intadd_55_CI), .CO(intadd_55_n3), .S(intadd_55_SUM_0_) );
  CMPR32X2TS intadd_55_U3 ( .A(FPSENCOS_d_ff2_Y[25]), .B(n2301), .C(
        intadd_55_n3), .CO(intadd_55_n2), .S(intadd_55_SUM_1_) );
  CMPR32X2TS intadd_55_U2 ( .A(FPSENCOS_d_ff2_Y[26]), .B(n5821), .C(
  ...
  CMPR32X2TS intadd_56_U4 ( .A(FPSENCOS_d_ff2_X[24]), .B(n5844), .C(
        intadd_56_CI), .CO(intadd_56_n3), .S(intadd_56_SUM_0_) );
  CMPR32X2TS intadd_56_U3 ( .A(FPSENCOS_d_ff2_X[25]), .B(n2301), .C(
        intadd_56_n3), .CO(intadd_56_n2), .S(intadd_56_SUM_1_) );
  CMPR32X2TS intadd_56_U2 ( .A(FPSENCOS_d_ff2_X[26]), .B(n5821), .C(
  ...
  OAI21X1TS U2810 ( .A0(n5452), .A1(intadd_55_CI), .B0(n4117), .Y(n1853) );
  NOR2X4TS U2811 ( .A(n5426), .B(n5112), .Y(n4070) );
  INVX3TS U2812 ( .A(n5586), .Y(n4272) );
  OAI21X1TS U2813 ( .A0(n5452), .A1(intadd_56_CI), .B0(n4118), .Y(n1951) );
  ...
  NAND2BX1TS U2885 ( .AN(FPSENCOS_d_ff2_X[23]), .B(n2285), .Y(intadd_56_CI) );
  ...
  AO22XLTS U3611 ( .A0(n5656), .A1(intadd_55_SUM_2_), .B0(n5655), .B1(
        FPSENCOS_d_ff3_sh_y_out[26]), .Y(n1850) );
  AO22XLTS U3612 ( .A0(n5583), .A1(intadd_55_SUM_1_), .B0(n5655), .B1(
        FPSENCOS_d_ff3_sh_y_out[25]), .Y(n1851) );
  AO22XLTS U3613 ( .A0(n5656), .A1(intadd_55_SUM_0_), .B0(n5655), .B1(
  ...
  NAND2X1TS U5679 ( .A(n2285), .B(n2252), .Y(intadd_55_CI) );
  ...
  OAI2BB2XLTS U6896 ( .B0(n5572), .B1(n2452), .A0N(n5577), .A1N(
        intadd_56_SUM_0_), .Y(n1950) );
  OAI2BB2XLTS U6897 ( .B0(n5572), .B1(n2468), .A0N(n5577), .A1N(
        intadd_56_SUM_1_), .Y(n1949) );
  OAI2BB2XLTS U6898 ( .B0(n5529), .B1(n2487), .A0N(n5577), .A1N(
        intadd_56_SUM_2_), .Y(n1948) );
  NOR2X1TS U6899 ( .A(FPSENCOS_d_ff2_X[27]), .B(intadd_56_n1), .Y(n5531) );
  AOI21X1TS U6900 ( .A0(intadd_56_n1), .A1(FPSENCOS_d_ff2_X[27]), .B0(n5531), 
        .Y(n5530) );
  OR3X1TS U6901 ( .A(FPSENCOS_d_ff2_X[27]), .B(FPSENCOS_d_ff2_X[28]), .C(
        intadd_56_n1), .Y(n5533) );
  ...
  OAI2BB2XLTS U6967 ( .B0(n5910), .B1(n5586), .A0N(FPSENCOS_d_ff_Yn[30]), 
        .A1N(n5570), .Y(n1854) );
  NOR2X2TS U6968 ( .A(FPSENCOS_d_ff2_Y[27]), .B(intadd_55_n1), .Y(n5574) );
  AOI21X1TS U6969 ( .A0(intadd_55_n1), .A1(FPSENCOS_d_ff2_Y[27]), .B0(n5574), 
        .Y(n5571) );
