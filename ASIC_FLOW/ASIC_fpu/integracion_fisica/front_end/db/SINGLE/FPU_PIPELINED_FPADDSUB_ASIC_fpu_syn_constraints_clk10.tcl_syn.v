...
module FPU_PIPELINED_FPADDSUB_W32_EW8_SW23_SWR26_EWR5 ( clk, rst, beg_OP, 
  ...
  wire   Shift_reg_FLAGS_7_6, intAS, SIGN_FLAG_EXP, OP_FLAG_EXP, ZERO_FLAG_EXP,
         ...
         n947, n948, n949, n950, n951, n952, DP_OP_15J66_122_6956_n18,
         DP_OP_15J66_122_6956_n17, DP_OP_15J66_122_6956_n16,
         DP_OP_15J66_122_6956_n15, DP_OP_15J66_122_6956_n14,
         DP_OP_15J66_122_6956_n8, DP_OP_15J66_122_6956_n7,
         DP_OP_15J66_122_6956_n6, DP_OP_15J66_122_6956_n5,
         DP_OP_15J66_122_6956_n4, DP_OP_15J66_122_6956_n3,
         DP_OP_15J66_122_6956_n2, DP_OP_15J66_122_6956_n1, sub_x_5_n131, n955,
  ...
  CMPR32X2TS DP_OP_15J66_122_6956_U9 ( .A(DMP_exp_NRM2_EW[0]), .B(n1997), .C(
        DP_OP_15J66_122_6956_n18), .CO(DP_OP_15J66_122_6956_n8), .S(
        exp_rslt_NRM2_EW1[0]) );
  ...
  DFFRX1TS EXP_STAGE_DmP_Q_reg_27_ ( .D(n640), .CK(clk), .RN(n2107), .Q(
        DmP_EXP_EWSW[27]) );
  ADDFHX2TS DP_OP_15J66_122_6956_U8 ( .A(DP_OP_15J66_122_6956_n17), .B(
        DMP_exp_NRM2_EW[1]), .CI(DP_OP_15J66_122_6956_n8), .CO(
        DP_OP_15J66_122_6956_n7), .S(exp_rslt_NRM2_EW1[1]) );
  ...
  DFFRX1TS SGF_STAGE_DmP_mant_Q_reg_0_ ( .D(n566), .CK(clk), .RN(n2116), .QN(
        sub_x_5_n131) );
  CMPR32X2TS DP_OP_15J66_122_6956_U7 ( .A(DP_OP_15J66_122_6956_n16), .B(
        DMP_exp_NRM2_EW[2]), .C(DP_OP_15J66_122_6956_n7), .CO(
        DP_OP_15J66_122_6956_n6), .S(exp_rslt_NRM2_EW1[2]) );
  CMPR32X2TS DP_OP_15J66_122_6956_U6 ( .A(DP_OP_15J66_122_6956_n15), .B(
        DMP_exp_NRM2_EW[3]), .C(DP_OP_15J66_122_6956_n6), .CO(
        DP_OP_15J66_122_6956_n5), .S(exp_rslt_NRM2_EW1[3]) );
  CMPR32X2TS DP_OP_15J66_122_6956_U5 ( .A(DP_OP_15J66_122_6956_n14), .B(
        DMP_exp_NRM2_EW[4]), .C(DP_OP_15J66_122_6956_n5), .CO(
        DP_OP_15J66_122_6956_n4), .S(exp_rslt_NRM2_EW1[4]) );
  CMPR32X2TS DP_OP_15J66_122_6956_U4 ( .A(n1997), .B(DMP_exp_NRM2_EW[5]), .C(
        DP_OP_15J66_122_6956_n4), .CO(DP_OP_15J66_122_6956_n3), .S(
        exp_rslt_NRM2_EW1[5]) );
  CMPR32X2TS DP_OP_15J66_122_6956_U3 ( .A(n1997), .B(DMP_exp_NRM2_EW[6]), .C(
        DP_OP_15J66_122_6956_n3), .CO(DP_OP_15J66_122_6956_n2), .S(
        exp_rslt_NRM2_EW1[6]) );
  DFFRX2TS inst_ShiftRegister_Q_reg_2_ ( .D(n946), .CK(clk), .RN(n2122), .Q(
        Shift_reg_FLAGS_7[2]), .QN(n996) );
  CMPR32X2TS DP_OP_15J66_122_6956_U2 ( .A(n1997), .B(DMP_exp_NRM2_EW[7]), .C(
        DP_OP_15J66_122_6956_n2), .CO(DP_OP_15J66_122_6956_n1), .S(
        exp_rslt_NRM2_EW1[7]) );
  ...
  XOR2X2TS U1135 ( .A(n1997), .B(n995), .Y(DP_OP_15J66_122_6956_n18) );
  ...
  XNOR2X2TS U1776 ( .A(DP_OP_15J66_122_6956_n1), .B(ADD_OVRFLW_NRM2), .Y(n1578) );
  ...
  XOR2X1TS U2159 ( .A(n1997), .B(n1584), .Y(DP_OP_15J66_122_6956_n14) );
  NOR2BX1TS U2160 ( .AN(LZD_output_NRM2_EW[3]), .B(ADD_OVRFLW_NRM2), .Y(n1585)
         );
  XOR2X1TS U2161 ( .A(n1997), .B(n1585), .Y(DP_OP_15J66_122_6956_n15) );
  NOR2BX1TS U2162 ( .AN(LZD_output_NRM2_EW[2]), .B(ADD_OVRFLW_NRM2), .Y(n1586)
         );
  XOR2X1TS U2163 ( .A(n1997), .B(n1586), .Y(DP_OP_15J66_122_6956_n16) );
  NOR2BX1TS U2164 ( .AN(LZD_output_NRM2_EW[1]), .B(ADD_OVRFLW_NRM2), .Y(n1587)
         );
  XOR2X1TS U2165 ( .A(n1997), .B(n1587), .Y(DP_OP_15J66_122_6956_n17) );
