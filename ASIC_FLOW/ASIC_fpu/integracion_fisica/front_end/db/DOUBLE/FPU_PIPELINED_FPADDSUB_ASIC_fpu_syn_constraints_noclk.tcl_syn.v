...
module FPU_PIPELINED_FPADDSUB_W64_EW11_SW52_SWR55_EWR6 ( clk, rst, beg_OP, 
  ...
  wire   n4087, Shift_reg_FLAGS_7_6, Shift_reg_FLAGS_7_5, intAS, SIGN_FLAG_EXP,
         ...
         DP_OP_15J90_122_2221_n22, DP_OP_15J90_122_2221_n21,
         DP_OP_15J90_122_2221_n20, DP_OP_15J90_122_2221_n19,
         DP_OP_15J90_122_2221_n18, DP_OP_15J90_122_2221_n17,
         DP_OP_15J90_122_2221_n11, DP_OP_15J90_122_2221_n10,
         DP_OP_15J90_122_2221_n9, DP_OP_15J90_122_2221_n8,
         DP_OP_15J90_122_2221_n7, DP_OP_15J90_122_2221_n6,
         DP_OP_15J90_122_2221_n5, DP_OP_15J90_122_2221_n4,
         DP_OP_15J90_122_2221_n3, DP_OP_15J90_122_2221_n2,
         DP_OP_15J90_122_2221_n1, n1895, n1896, n1897, n1898, n1899, n1900,
  ...
  CMPR32X2TS DP_OP_15J90_122_2221_U12 ( .A(DMP_exp_NRM2_EW[0]), .B(n2029), .C(
        DP_OP_15J90_122_2221_n22), .CO(DP_OP_15J90_122_2221_n11), .S(
        exp_rslt_NRM2_EW1[0]) );
  CMPR32X2TS DP_OP_15J90_122_2221_U11 ( .A(DP_OP_15J90_122_2221_n21), .B(
        DMP_exp_NRM2_EW[1]), .C(DP_OP_15J90_122_2221_n11), .CO(
        DP_OP_15J90_122_2221_n10), .S(exp_rslt_NRM2_EW1[1]) );
  CMPR32X2TS DP_OP_15J90_122_2221_U10 ( .A(DP_OP_15J90_122_2221_n20), .B(
        DMP_exp_NRM2_EW[2]), .C(DP_OP_15J90_122_2221_n10), .CO(
        DP_OP_15J90_122_2221_n9), .S(exp_rslt_NRM2_EW1[2]) );
  CMPR32X2TS DP_OP_15J90_122_2221_U9 ( .A(DP_OP_15J90_122_2221_n19), .B(
        DMP_exp_NRM2_EW[3]), .C(DP_OP_15J90_122_2221_n9), .CO(
        DP_OP_15J90_122_2221_n8), .S(exp_rslt_NRM2_EW1[3]) );
  CMPR32X2TS DP_OP_15J90_122_2221_U8 ( .A(DP_OP_15J90_122_2221_n18), .B(
        DMP_exp_NRM2_EW[4]), .C(DP_OP_15J90_122_2221_n8), .CO(
        DP_OP_15J90_122_2221_n7), .S(exp_rslt_NRM2_EW1[4]) );
  CMPR32X2TS DP_OP_15J90_122_2221_U7 ( .A(DP_OP_15J90_122_2221_n17), .B(
        DMP_exp_NRM2_EW[5]), .C(DP_OP_15J90_122_2221_n7), .CO(
        DP_OP_15J90_122_2221_n6), .S(exp_rslt_NRM2_EW1[5]) );
  CMPR32X2TS DP_OP_15J90_122_2221_U6 ( .A(n2029), .B(DMP_exp_NRM2_EW[6]), .C(
        DP_OP_15J90_122_2221_n6), .CO(DP_OP_15J90_122_2221_n5), .S(
        exp_rslt_NRM2_EW1[6]) );
  CMPR32X2TS DP_OP_15J90_122_2221_U5 ( .A(n2029), .B(DMP_exp_NRM2_EW[7]), .C(
        DP_OP_15J90_122_2221_n5), .CO(DP_OP_15J90_122_2221_n4), .S(
        exp_rslt_NRM2_EW1[7]) );
  CMPR32X2TS DP_OP_15J90_122_2221_U4 ( .A(n2029), .B(DMP_exp_NRM2_EW[8]), .C(
        DP_OP_15J90_122_2221_n4), .CO(DP_OP_15J90_122_2221_n3), .S(
        exp_rslt_NRM2_EW1[8]) );
  CMPR32X2TS DP_OP_15J90_122_2221_U3 ( .A(n2029), .B(DMP_exp_NRM2_EW[9]), .C(
        DP_OP_15J90_122_2221_n3), .CO(DP_OP_15J90_122_2221_n2), .S(
        exp_rslt_NRM2_EW1[9]) );
  CMPR32X2TS DP_OP_15J90_122_2221_U2 ( .A(n2029), .B(DMP_exp_NRM2_EW[10]), .C(
        DP_OP_15J90_122_2221_n2), .CO(DP_OP_15J90_122_2221_n1), .S(
  ...
  XOR2X1TS U2466 ( .A(DP_OP_15J90_122_2221_n1), .B(ADD_OVRFLW_NRM2), .Y(n2053)
         );
  ...
  XOR2X1TS U4241 ( .A(n1895), .B(n3289), .Y(DP_OP_15J90_122_2221_n18) );
  NOR2BX1TS U4242 ( .AN(LZD_output_NRM2_EW[5]), .B(ADD_OVRFLW_NRM2), .Y(n3290)
         );
  XOR2X1TS U4243 ( .A(n1895), .B(n3290), .Y(DP_OP_15J90_122_2221_n17) );
  NOR2BX1TS U4244 ( .AN(LZD_output_NRM2_EW[1]), .B(ADD_OVRFLW_NRM2), .Y(n3291)
         );
  XOR2X1TS U4245 ( .A(n1895), .B(n3291), .Y(DP_OP_15J90_122_2221_n21) );
  NOR2BX1TS U4246 ( .AN(LZD_output_NRM2_EW[2]), .B(ADD_OVRFLW_NRM2), .Y(n3292)
         );
  XOR2X1TS U4247 ( .A(n1895), .B(n3292), .Y(DP_OP_15J90_122_2221_n20) );
  NOR2BX1TS U4248 ( .AN(LZD_output_NRM2_EW[3]), .B(ADD_OVRFLW_NRM2), .Y(n3293)
         );
  XOR2X1TS U4249 ( .A(n1895), .B(n3293), .Y(DP_OP_15J90_122_2221_n19) );
  OR2X1TS U4250 ( .A(ADD_OVRFLW_NRM2), .B(LZD_output_NRM2_EW[0]), .Y(n3294) );
  XOR2X1TS U4251 ( .A(n1895), .B(n3294), .Y(DP_OP_15J90_122_2221_n22) );
