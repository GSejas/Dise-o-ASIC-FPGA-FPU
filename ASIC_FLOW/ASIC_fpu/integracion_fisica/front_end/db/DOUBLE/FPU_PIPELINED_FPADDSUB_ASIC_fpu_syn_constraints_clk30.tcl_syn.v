...
module FPU_PIPELINED_FPADDSUB_W64_EW11_SW52_SWR55_EWR6 ( clk, rst, beg_OP, 
  ...
  wire   n3818, Shift_reg_FLAGS_7_6, Shift_reg_FLAGS_7_5, intAS, SIGN_FLAG_EXP,
         ...
         n1888, n1889, n1890, n1891, n1892, DP_OP_15J178_122_2221_n22,
         DP_OP_15J178_122_2221_n21, DP_OP_15J178_122_2221_n20,
         DP_OP_15J178_122_2221_n19, DP_OP_15J178_122_2221_n18,
         DP_OP_15J178_122_2221_n17, DP_OP_15J178_122_2221_n11,
         DP_OP_15J178_122_2221_n10, DP_OP_15J178_122_2221_n9,
         DP_OP_15J178_122_2221_n8, DP_OP_15J178_122_2221_n7,
         DP_OP_15J178_122_2221_n6, DP_OP_15J178_122_2221_n5,
         DP_OP_15J178_122_2221_n4, DP_OP_15J178_122_2221_n3,
         DP_OP_15J178_122_2221_n2, DP_OP_15J178_122_2221_n1, sub_x_5_n107,
  ...
  CMPR32X2TS DP_OP_15J178_122_2221_U11 ( .A(DP_OP_15J178_122_2221_n21), .B(
        DMP_exp_NRM2_EW[1]), .C(DP_OP_15J178_122_2221_n11), .CO(
        DP_OP_15J178_122_2221_n10), .S(exp_rslt_NRM2_EW1[1]) );
  CMPR32X2TS DP_OP_15J178_122_2221_U10 ( .A(DP_OP_15J178_122_2221_n20), .B(
        DMP_exp_NRM2_EW[2]), .C(DP_OP_15J178_122_2221_n10), .CO(
        DP_OP_15J178_122_2221_n9), .S(exp_rslt_NRM2_EW1[2]) );
  CMPR32X2TS DP_OP_15J178_122_2221_U9 ( .A(DP_OP_15J178_122_2221_n19), .B(
        DMP_exp_NRM2_EW[3]), .C(DP_OP_15J178_122_2221_n9), .CO(
        DP_OP_15J178_122_2221_n8), .S(exp_rslt_NRM2_EW1[3]) );
  CMPR32X2TS DP_OP_15J178_122_2221_U8 ( .A(DP_OP_15J178_122_2221_n18), .B(
        DMP_exp_NRM2_EW[4]), .C(DP_OP_15J178_122_2221_n8), .CO(
        DP_OP_15J178_122_2221_n7), .S(exp_rslt_NRM2_EW1[4]) );
  CMPR32X2TS DP_OP_15J178_122_2221_U7 ( .A(DP_OP_15J178_122_2221_n17), .B(
        DMP_exp_NRM2_EW[5]), .C(DP_OP_15J178_122_2221_n7), .CO(
        DP_OP_15J178_122_2221_n6), .S(exp_rslt_NRM2_EW1[5]) );
  CMPR32X2TS DP_OP_15J178_122_2221_U6 ( .A(n1895), .B(DMP_exp_NRM2_EW[6]), .C(
        DP_OP_15J178_122_2221_n6), .CO(DP_OP_15J178_122_2221_n5), .S(
        exp_rslt_NRM2_EW1[6]) );
  CMPR32X2TS DP_OP_15J178_122_2221_U5 ( .A(n1895), .B(DMP_exp_NRM2_EW[7]), .C(
        DP_OP_15J178_122_2221_n5), .CO(DP_OP_15J178_122_2221_n4), .S(
        exp_rslt_NRM2_EW1[7]) );
  CMPR32X2TS DP_OP_15J178_122_2221_U4 ( .A(n1895), .B(DMP_exp_NRM2_EW[8]), .C(
        DP_OP_15J178_122_2221_n4), .CO(DP_OP_15J178_122_2221_n3), .S(
        exp_rslt_NRM2_EW1[8]) );
  CMPR32X2TS DP_OP_15J178_122_2221_U3 ( .A(n1895), .B(DMP_exp_NRM2_EW[9]), .C(
        DP_OP_15J178_122_2221_n3), .CO(DP_OP_15J178_122_2221_n2), .S(
        exp_rslt_NRM2_EW1[9]) );
  CMPR32X2TS DP_OP_15J178_122_2221_U2 ( .A(n1895), .B(DMP_exp_NRM2_EW[10]), 
        .C(DP_OP_15J178_122_2221_n2), .CO(DP_OP_15J178_122_2221_n1), .S(
  ...
  CMPR32X2TS DP_OP_15J178_122_2221_U12 ( .A(DMP_exp_NRM2_EW[0]), .B(n1895), 
        .C(DP_OP_15J178_122_2221_n22), .CO(DP_OP_15J178_122_2221_n11), .S(
        exp_rslt_NRM2_EW1[0]) );
  ...
  XNOR2X1TS U2710 ( .A(DP_OP_15J178_122_2221_n1), .B(ADD_OVRFLW_NRM2), .Y(
        n2151) );
  ...
  XOR2X1TS U3859 ( .A(n1895), .B(n3387), .Y(DP_OP_15J178_122_2221_n17) );
  NOR2BX1TS U3860 ( .AN(LZD_output_NRM2_EW[4]), .B(ADD_OVRFLW_NRM2), .Y(n3388)
         );
  XOR2X1TS U3861 ( .A(n1895), .B(n3388), .Y(DP_OP_15J178_122_2221_n18) );
  NOR2BX1TS U3862 ( .AN(LZD_output_NRM2_EW[3]), .B(ADD_OVRFLW_NRM2), .Y(n3389)
         );
  XOR2X1TS U3863 ( .A(n1895), .B(n3389), .Y(DP_OP_15J178_122_2221_n19) );
  NOR2BX1TS U3864 ( .AN(LZD_output_NRM2_EW[2]), .B(ADD_OVRFLW_NRM2), .Y(n3390)
         );
  XOR2X1TS U3865 ( .A(n1895), .B(n3390), .Y(DP_OP_15J178_122_2221_n20) );
  NOR2BX1TS U3866 ( .AN(LZD_output_NRM2_EW[1]), .B(ADD_OVRFLW_NRM2), .Y(n3391)
         );
  XOR2X1TS U3867 ( .A(n1895), .B(n3391), .Y(DP_OP_15J178_122_2221_n21) );
  OR2X1TS U3868 ( .A(LZD_output_NRM2_EW[0]), .B(ADD_OVRFLW_NRM2), .Y(n3392) );
  XOR2X1TS U3869 ( .A(n1895), .B(n3392), .Y(DP_OP_15J178_122_2221_n22) );
