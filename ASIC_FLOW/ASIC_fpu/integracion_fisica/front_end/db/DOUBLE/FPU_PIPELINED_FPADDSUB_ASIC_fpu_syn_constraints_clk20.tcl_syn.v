...
module FPU_PIPELINED_FPADDSUB_W64_EW11_SW52_SWR55_EWR6 ( clk, rst, beg_OP, 
  ...
  wire   n4117, Shift_reg_FLAGS_7_6, intAS, SIGN_FLAG_EXP, OP_FLAG_EXP,
         ...
         DP_OP_15J177_122_2221_n22, DP_OP_15J177_122_2221_n21,
         DP_OP_15J177_122_2221_n20, DP_OP_15J177_122_2221_n19,
         DP_OP_15J177_122_2221_n18, DP_OP_15J177_122_2221_n17,
         DP_OP_15J177_122_2221_n11, DP_OP_15J177_122_2221_n10,
         DP_OP_15J177_122_2221_n9, DP_OP_15J177_122_2221_n8,
         DP_OP_15J177_122_2221_n7, DP_OP_15J177_122_2221_n6,
         DP_OP_15J177_122_2221_n5, DP_OP_15J177_122_2221_n4,
         DP_OP_15J177_122_2221_n3, DP_OP_15J177_122_2221_n2,
         DP_OP_15J177_122_2221_n1, n1895, n1896, n1897, n1898, n1899, n1900,
  ...
  CMPR32X2TS DP_OP_15J177_122_2221_U12 ( .A(DMP_exp_NRM2_EW[0]), .B(n1895), 
        .C(DP_OP_15J177_122_2221_n22), .CO(DP_OP_15J177_122_2221_n11), .S(
        exp_rslt_NRM2_EW1[0]) );
  ...
  ADDFX1TS DP_OP_15J177_122_2221_U4 ( .A(n1895), .B(DMP_exp_NRM2_EW[8]), .CI(
        DP_OP_15J177_122_2221_n4), .CO(DP_OP_15J177_122_2221_n3), .S(
        exp_rslt_NRM2_EW1[8]) );
  DFFRX4TS SFT2FRMT_STAGE_FLAGS_Q_reg_2_ ( .D(n1276), .CK(clk), .RN(n4090), 
        .Q(ADD_OVRFLW_NRM2), .QN(n1895) );
  CMPR32X2TS DP_OP_15J177_122_2221_U11 ( .A(DP_OP_15J177_122_2221_n21), .B(
        DMP_exp_NRM2_EW[1]), .C(DP_OP_15J177_122_2221_n11), .CO(
        DP_OP_15J177_122_2221_n10), .S(exp_rslt_NRM2_EW1[1]) );
  CMPR32X2TS DP_OP_15J177_122_2221_U10 ( .A(DP_OP_15J177_122_2221_n20), .B(
        DMP_exp_NRM2_EW[2]), .C(DP_OP_15J177_122_2221_n10), .CO(
        DP_OP_15J177_122_2221_n9), .S(exp_rslt_NRM2_EW1[2]) );
  CMPR32X2TS DP_OP_15J177_122_2221_U9 ( .A(DP_OP_15J177_122_2221_n19), .B(
        DMP_exp_NRM2_EW[3]), .C(DP_OP_15J177_122_2221_n9), .CO(
        DP_OP_15J177_122_2221_n8), .S(exp_rslt_NRM2_EW1[3]) );
  CMPR32X2TS DP_OP_15J177_122_2221_U8 ( .A(DP_OP_15J177_122_2221_n18), .B(
        DMP_exp_NRM2_EW[4]), .C(DP_OP_15J177_122_2221_n8), .CO(
        DP_OP_15J177_122_2221_n7), .S(exp_rslt_NRM2_EW1[4]) );
  CMPR32X2TS DP_OP_15J177_122_2221_U7 ( .A(DP_OP_15J177_122_2221_n17), .B(
        DMP_exp_NRM2_EW[5]), .C(DP_OP_15J177_122_2221_n7), .CO(
        DP_OP_15J177_122_2221_n6), .S(exp_rslt_NRM2_EW1[5]) );
  CMPR32X2TS DP_OP_15J177_122_2221_U6 ( .A(n1895), .B(DMP_exp_NRM2_EW[6]), .C(
        DP_OP_15J177_122_2221_n6), .CO(DP_OP_15J177_122_2221_n5), .S(
        exp_rslt_NRM2_EW1[6]) );
  CMPR32X2TS DP_OP_15J177_122_2221_U5 ( .A(n1895), .B(DMP_exp_NRM2_EW[7]), .C(
        DP_OP_15J177_122_2221_n5), .CO(DP_OP_15J177_122_2221_n4), .S(
        exp_rslt_NRM2_EW1[7]) );
  DFFRX4TS inst_ShiftRegister_Q_reg_1_ ( .D(n1885), .CK(clk), .RN(n4055), .Q(
        Shift_reg_FLAGS_7[1]), .QN(n1900) );
  CMPR32X2TS DP_OP_15J177_122_2221_U3 ( .A(n1895), .B(DMP_exp_NRM2_EW[9]), .C(
        DP_OP_15J177_122_2221_n3), .CO(DP_OP_15J177_122_2221_n2), .S(
        exp_rslt_NRM2_EW1[9]) );
  CMPR32X2TS DP_OP_15J177_122_2221_U2 ( .A(n1895), .B(DMP_exp_NRM2_EW[10]), 
        .C(DP_OP_15J177_122_2221_n2), .CO(DP_OP_15J177_122_2221_n1), .S(
  ...
  XNOR2X1TS U2883 ( .A(DP_OP_15J177_122_2221_n1), .B(ADD_OVRFLW_NRM2), .Y(
        n2091) );
  ...
  XOR2X1TS U3784 ( .A(n1895), .B(n3136), .Y(DP_OP_15J177_122_2221_n17) );
  NOR2BX1TS U3785 ( .AN(LZD_output_NRM2_EW[4]), .B(ADD_OVRFLW_NRM2), .Y(n3137)
         );
  XOR2X1TS U3786 ( .A(n1895), .B(n3137), .Y(DP_OP_15J177_122_2221_n18) );
  NOR2BX1TS U3787 ( .AN(LZD_output_NRM2_EW[3]), .B(ADD_OVRFLW_NRM2), .Y(n3138)
         );
  XOR2X1TS U3788 ( .A(n1895), .B(n3138), .Y(DP_OP_15J177_122_2221_n19) );
  NOR2BX1TS U3789 ( .AN(LZD_output_NRM2_EW[2]), .B(ADD_OVRFLW_NRM2), .Y(n3139)
         );
  XOR2X1TS U3790 ( .A(n1895), .B(n3139), .Y(DP_OP_15J177_122_2221_n20) );
  NOR2BX1TS U3791 ( .AN(LZD_output_NRM2_EW[1]), .B(ADD_OVRFLW_NRM2), .Y(n3140)
         );
  XOR2X1TS U3792 ( .A(n1895), .B(n3140), .Y(DP_OP_15J177_122_2221_n21) );
  XOR2X1TS U3793 ( .A(n1895), .B(n3141), .Y(DP_OP_15J177_122_2221_n22) );
