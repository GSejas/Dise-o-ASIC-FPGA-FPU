...
# DVE full session
# Saved on Sun Nov 13 21:11:32 2016
# Designs open: 1
#   Sim: /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_KOA1/DOUBLE/simv
...
#<Session mode="Full" path="/mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_KOA1/DOUBLE/DVEfiles/session.tcl" type="Debug">
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +lint=all -a log_name +define+DOUBLE +define+KOA1_DOUBLE +neg_tchk +sdfverbose}}
gui_set_env SIMSETUP::SIMEXE {simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_KOA1/DOUBLE/simv}] } {
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+DOUBLE +define+KOA1_DOUBLE +neg_tchk +sdfverbose -ucligui} -dir /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_KOA1/DOUBLE -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 139765 242032
gui_list_add_group -id ${Wave.1} -after {New Group} {Testbench_FPU_Mark2}
gui_list_select -id ${Wave.1} {Testbench_FPU_Mark2.II }
...
gui_marker_move -id ${Wave.1} {C1} 140000
gui_view_scroll -id ${Wave.1} -vertical -set 251
gui_show_grid -id ${Wave.1} -enable false

# Source 'Source.1'
gui_src_value_annotate -id ${Source.1} -switch false
gui_set_env TOGGLE::VALUEANNOTATE 0
gui_open_source -id ${Source.1}  -replace -active Testbench_FPU_Mark2 /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_KOA1/DOUBLE/./Testbench_all_operators.v
