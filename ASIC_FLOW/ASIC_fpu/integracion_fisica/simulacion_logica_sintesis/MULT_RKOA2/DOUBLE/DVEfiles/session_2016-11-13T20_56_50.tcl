...
# DVE full session
# Saved on Sun Nov 13 21:35:31 2016
# Designs open: 1
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +lint=all -a log_name +define+DOUBLE +define+RKOA2_DOUBLE +neg_tchk +sdfverbose}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+DOUBLE +define+RKOA2_DOUBLE +neg_tchk +sdfverbose -ucligui} -dir /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_RKOA2/DOUBLE -nosource
}
}
...
# Restore C1 time
gui_set_time -C1_only 41645310000
...
gui_wv_zoom_timerange -id ${Wave.1} 41645309881 41645310119
...
gui_marker_move -id ${Wave.1} {C1} 41645310000
