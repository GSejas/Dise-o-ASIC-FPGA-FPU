...
# DVE full session
# Saved on Sun Nov 13 21:26:50 2016
# Designs open: 1
...
# Restore C1 time
gui_set_time -C1_only 103366314
...
gui_wv_zoom_timerange -id ${Wave.1} 103333730 103546915
...
gui_marker_move -id ${Wave.1} {C1} 103366314
...
gui_open_source -id ${Source.1} ibm13rflpvt.v -startline 18 -replace
gui_view_scroll -id ${Source.1} -vertical -set 111660
