...
# DVE full session
# Saved on Mon Oct 31 02:43:43 2016
# Designs open: 1
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 587} {child_wave_right 431} {child_wave_colname 300} {child_wave_colvalue 283} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMARGS {{ +v2k +lint=all -a log_name +define+DOUBLE +neg_tchk +sdfverbose -ucligui}}
gui_set_env SIMSETUP::SIMEXE {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/DOUBLE/simv}
...
gui_sg_addsignal -group "$_session_group_1" { Testbench_FPU_Mark1.EW Testbench_FPU_Mark1.Data_1 Testbench_FPU_Mark1.Data_2 Testbench_FPU_Mark1.op_result Testbench_FPU_Mark1.contador Testbench_FPU_Mark1.FPSEN Testbench_FPU_Mark1.Array_IN_1 Testbench_FPU_Mark1.II Testbench_FPU_Mark1.Array_IN_2 Testbench_FPU_Mark1.FPSUB Testbench_FPU_Mark1.SW Testbench_FPU_Mark1.begin_operation Testbench_FPU_Mark1.underflow_flag Testbench_FPU_Mark1.FileSaveData Testbench_FPU_Mark1.ack_operation Testbench_FPU_Mark1.SWR Testbench_FPU_Mark1.operation_ready Testbench_FPU_Mark1.PERIOD Testbench_FPU_Mark1.region_flag Testbench_FPU_Mark1.EWR Testbench_FPU_Mark1.NaN_flag Testbench_FPU_Mark1.ROUNDING_MODE_POS_INF Testbench_FPU_Mark1.W Testbench_FPU_Mark1.operation Testbench_FPU_Mark1.III Testbench_FPU_Mark1.FPMULT Testbench_FPU_Mark1.clk Testbench_FPU_Mark1.r_mode Testbench_FPU_Mark1.overflow_flag Testbench_FPU_Mark1.IoIV1 Testbench_FPU_Mark1.IoIV2 Testbench_FPU_Mark1.FPCOS Testbench_FPU_Mark1.FPADD Testbench_FPU_Mark1.ROUNDING_MODE_TRUNCT Testbench_FPU_Mark1.rst Testbench_FPU_Mark1.ROUNDING_MODE_NEG_INF }
...
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:Testbench_FPU_Mark1.Data_1}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:Testbench_FPU_Mark1.Data_2}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:Testbench_FPU_Mark1.op_result}
...
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:Testbench_FPU_Mark1.Array_IN_1}
...
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:Testbench_FPU_Mark1.Array_IN_2}
...
# Restore C1 time
gui_set_time -C1_only 12885087068
...
gui_wv_zoom_timerange -id ${Wave.1} 12885040979 12885185578
gui_list_add_group -id ${Wave.1} -after {New Group} {Testbench_FPU_Mark1}
gui_list_select -id ${Wave.1} {Testbench_FPU_Mark1.Data_1 }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Testbench_FPU_Mark1  -item {Testbench_FPU_Mark1.op_result[63:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 12885087068
