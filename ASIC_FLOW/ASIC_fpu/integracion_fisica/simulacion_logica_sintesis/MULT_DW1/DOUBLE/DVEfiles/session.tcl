...
# DVE full session
# Saved on Sun Nov 13 20:32:28 2016
# Designs open: 1
#   Sim: /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_DW1/DOUBLE/simv
...
#<Session mode="Full" path="/mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_DW1/DOUBLE/DVEfiles/session.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_hier_colhier 920} {child_hier_coltype 444} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 343} {child_data_colvalue 823} {child_data_coltype 197} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Wave.1 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.1} -show_state maximized
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 622} {child_wave_right 740} {child_wave_colname 375} {child_wave_colvalue 243} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMARGS {{ +v2k +lint=all -l log_name +define+DOUBLE +define+DW1_DOUBLE +neg_tchk +sdfverbose -ucligui}}
gui_set_env SIMSETUP::SIMEXE {/mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_DW1/DOUBLE/simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_DW1/DOUBLE/simv}] } {
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -l log_name +define+DOUBLE +define+DW1_DOUBLE +neg_tchk +sdfverbose -ucligui} -dir /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_DW1/DOUBLE -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_2" { Testbench_FPU_Mark2.EW Testbench_FPU_Mark2.Data_1 Testbench_FPU_Mark2.Data_2 Testbench_FPU_Mark2.FileSaveData_FLOAT Testbench_FPU_Mark2.contador Testbench_FPU_Mark2.FPSEN Testbench_FPU_Mark2.Array_IN_1 Testbench_FPU_Mark2.II Testbench_FPU_Mark2.Array_IN_2 Testbench_FPU_Mark2.FPSUB Testbench_FPU_Mark2.SW Testbench_FPU_Mark2.begin_operation Testbench_FPU_Mark2.underflow_flag Testbench_FPU_Mark2.FileSaveData Testbench_FPU_Mark2.PIPE Testbench_FPU_Mark2.ack_operation Testbench_FPU_Mark2.SWR Testbench_FPU_Mark2.operation_ready Testbench_FPU_Mark2.PERIOD Testbench_FPU_Mark2.region_flag Testbench_FPU_Mark2.op_result Testbench_FPU_Mark2.add_subt Testbench_FPU_Mark2.EWR Testbench_FPU_Mark2.NaN_flag Testbench_FPU_Mark2.ROUNDING_MODE_POS_INF Testbench_FPU_Mark2.W Testbench_FPU_Mark2.busy Testbench_FPU_Mark2.operation Testbench_FPU_Mark2.III Testbench_FPU_Mark2.FPMULT Testbench_FPU_Mark2.clk Testbench_FPU_Mark2.r_mode Testbench_FPU_Mark2.overflow_flag Testbench_FPU_Mark2.IoIV1 Testbench_FPU_Mark2.zero_flag Testbench_FPU_Mark2.IoIV2 Testbench_FPU_Mark2.FPCOS Testbench_FPU_Mark2.FPADD Testbench_FPU_Mark2.ROUNDING_MODE_TRUNCT Testbench_FPU_Mark2.rst Testbench_FPU_Mark2.ROUNDING_MODE_NEG_INF }
...
gui_set_radix -radix {decimal} -signals {Sim:Testbench_FPU_Mark2.FileSaveData_FLOAT}
gui_set_radix -radix {twosComplement} -signals {Sim:Testbench_FPU_Mark2.FileSaveData_FLOAT}
gui_set_radix -radix {decimal} -signals {Sim:Testbench_FPU_Mark2.contador}
...
gui_set_radix -radix {decimal} -signals {Sim:Testbench_FPU_Mark2.FileSaveData}
gui_set_radix -radix {twosComplement} -signals {Sim:Testbench_FPU_Mark2.FileSaveData}
gui_set_radix -radix {decimal} -signals {Sim:Testbench_FPU_Mark2.PIPE}
gui_set_radix -radix {twosComplement} -signals {Sim:Testbench_FPU_Mark2.PIPE}
...
gui_wv_zoom_timerange -id ${Wave.1} 56420000 169260000
...
gui_open_source -id ${Source.1}  -replace -active Testbench_FPU_Mark2 /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_DW1/DOUBLE/./Testbench_all_operators.v
gui_view_scroll -id ${Source.1} -vertical -set 6930
