...
# DVE full session
# Saved on Sun Nov 13 20:28:33 2016
# Designs open: 1
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +lint=all -a log_name +define+DOUBLE +define+DW1_DOUBLE +neg_tchk +sdfverbose}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+DOUBLE +define+DW1_DOUBLE +neg_tchk +sdfverbose -ucligui} -dir /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_DW1/DOUBLE -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 666468
gui_list_add_group -id ${Wave.1} -after {New Group} {Testbench_FPU_Mark2}
gui_list_select -id ${Wave.1} {Testbench_FPU_Mark2.underflow_flag }
...
gui_marker_move -id ${Wave.1} {C1} 220000
...
gui_view_scroll -id ${Source.1} -vertical -set 6932
