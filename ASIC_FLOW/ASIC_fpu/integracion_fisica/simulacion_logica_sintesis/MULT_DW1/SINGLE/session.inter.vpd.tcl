...
# DVE full session
# Saved on Sat Nov 12 18:59:25 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_DW1/SINGLE/session.inter.vpd.tcl" type="Debug">
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SINGLE +define+DW1_SINGLE +neg_tchk +sdfverbose -ucligui} -dir ../SINGLE -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active Testbench_FPU_Mark2 Testbench_all_operators.v
