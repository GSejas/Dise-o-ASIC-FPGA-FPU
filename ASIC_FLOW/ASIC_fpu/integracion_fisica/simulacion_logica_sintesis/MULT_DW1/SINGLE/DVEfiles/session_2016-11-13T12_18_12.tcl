...
# DVE full session
# Saved on Sun Nov 13 12:56:53 2016
# Designs open: 1
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 622} {child_wave_right 740} {child_wave_colname 362} {child_wave_colvalue 255} {child_wave_col1 0} {child_wave_col2 1}}
...
# Restore C1 time
gui_set_time -C1_only 2943755000
...
gui_wv_zoom_timerange -id ${Wave.1} 0 2943755000
gui_list_add_group -id ${Wave.1} -after {New Group} {Testbench_FPU_Mark2}
gui_list_select -id ${Wave.1} {Testbench_FPU_Mark2.Data_2 }
...
gui_marker_move -id ${Wave.1} {C1} 2943755000
