...
# DVE full session
# Saved on Sun Nov 13 12:53:07 2016
# Designs open: 1
...
#<Session mode="Full" path="/mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_DW1/SINGLE/DVEfiles/session.tcl" type="Debug">
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 622} {child_wave_right 740} {child_wave_colname 365} {child_wave_colvalue 252} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMARGS {{-ucligui +v2k +lint=all -l log_name +define+SINGLE +define+DW1_SINGLE +neg_tchk +sdfverbose}}
...
gui_sim_run Ucli -exe simv -args {-ucligui +v2k +lint=all -l log_name +define+SINGLE +define+DW1_SINGLE +neg_tchk +sdfverbose} -dir /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_sintesis/MULT_DW1/SINGLE -nosource
}
}
...
# Restore C1 time
gui_set_time -C1_only 143588254
...
gui_wv_zoom_timerange -id ${Wave.1} 143581620 143618364
gui_list_add_group -id ${Wave.1} -after {New Group} {Testbench_FPU_Mark2}
gui_list_select -id ${Wave.1} {Testbench_FPU_Mark2.EW }
...
gui_marker_move -id ${Wave.1} {C1} 143588254
