...
# DVE full session
# Saved on Sun Nov 13 12:32:42 2016
# Designs open: 1
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 622} {child_wave_right 740} {child_wave_colname 369} {child_wave_colvalue 248} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 143600000
gui_list_add_group -id ${Wave.1} -after {New Group} {Testbench_FPU_Mark2}
gui_list_select -id ${Wave.1} {Testbench_FPU_Mark2.clk }
...
gui_marker_move -id ${Wave.1} {C1} 30315556
