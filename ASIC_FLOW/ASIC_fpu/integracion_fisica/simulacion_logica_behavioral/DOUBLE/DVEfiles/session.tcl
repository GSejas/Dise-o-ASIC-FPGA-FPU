...
# DVE full session
# Saved on Mon Oct 31 15:34:00 2016
# Designs open: 1
...
#   Wave.1: 37 signals
#   Group count = 1
#   Group Testbench_FPU_Mark1 signal count = 37
...
gui_set_radix -radix {decimal} -signals {Sim:Testbench_FPU_Mark1.FileSaveDataF}
gui_set_radix -radix {twosComplement} -signals {Sim:Testbench_FPU_Mark1.FileSaveDataF}
...
# Restore C1 time
gui_set_time -C1_only 48635430000
...
gui_wv_zoom_timerange -id ${Wave.1} 48635429912 48635430088
...
gui_marker_move -id ${Wave.1} {C1} 48635430000
