...
# DVE full session
# Saved on Mon Oct 31 00:12:51 2016
# Designs open: 1
...
gui_set_env SIMSETUP::SIMARGS {{-ucligui +v2k +lint=all -l log_name +define+DOUBLE +neg_tchk +sdfverbose}}
gui_set_env SIMSETUP::SIMEXE {/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_behavioral/DOUBLE/simv}
...
gui_sim_run Ucli -exe simv -args {-ucligui +v2k +lint=all -l log_name +define+DOUBLE +neg_tchk +sdfverbose} -dir /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_behavioral/DOUBLE -nosource
}
}
...
# Restore C1 time
gui_set_time -C1_only 49149270000
...
gui_wv_zoom_timerange -id ${Wave.1} 49149269911 49149270088
...
gui_marker_move -id ${Wave.1} {C1} 49149270000
...
gui_open_source -id ${Source.1}  -replace -active Mux_3x1_bv2 /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpu/integracion_fisica/simulacion_logica_behavioral/DOUBLE/../../front_end/source/Mux_3x1_b_v2.v
