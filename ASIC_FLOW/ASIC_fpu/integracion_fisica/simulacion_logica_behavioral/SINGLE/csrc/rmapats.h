...
void  hsM_39_5__simv_daidir (UB  * pcode, UB  val);
...
void  hsM_46_5__simv_daidir (UB  * pcode, UB  val);
...
void  hsM_79_1__simv_daidir (UB  * pcode, scalar  val, U  I627, scalar  * I1074);
void  hsM_79_2__simv_daidir (UB  * pcode);
