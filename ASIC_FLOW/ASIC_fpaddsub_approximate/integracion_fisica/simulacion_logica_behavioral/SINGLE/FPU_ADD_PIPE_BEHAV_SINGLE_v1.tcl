...
# DVE full session
# Saved on Thu Oct 20 18:01:33 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_behavioral/SINGLE/FPU_ADD_PIPE_BEHAV_SINGLE_v1.tcl" type="Debug">
...
set _session_group_51 Group1
gui_sg_create "$_session_group_51"
set Group1 "$_session_group_51"

gui_sg_addsignal -group "$_session_group_51" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee }
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}

set _session_group_52 Group2
gui_sg_create "$_session_group_52"
set Group2 "$_session_group_52"

gui_sg_addsignal -group "$_session_group_52" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee }
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_X}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Data_Y}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.Theoretical_result}
gui_set_radix -radix {Hex2Float_BigEndian} -signals {Sim:tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee}

set _session_group_53 Group3
gui_sg_create "$_session_group_53"
set Group3 "$_session_group_53"
...
set _session_group_54 Group4
gui_sg_create "$_session_group_54"
set Group4 "$_session_group_54"

gui_sg_addsignal -group "$_session_group_54" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDX_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDY_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intAS tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.eqXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.gtXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_INIT }

set _session_group_55 SHT1_STAGE_DMP
gui_sg_create "$_session_group_55"
set SHT1_STAGE_DMP "$_session_group_55"

gui_sg_addsignal -group "$_session_group_55" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.Q tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_STAGE_DMP.rst }
...
set _session_group_56 SHT1_STAGE_DmP_mant
gui_sg_create "$_session_group_56"
set SHT1_STAGE_DmP_mant "$_session_group_56"
...
set _session_group_59 INPUT_STAGE_FLAGS
gui_sg_create "$_session_group_59"
set INPUT_STAGE_FLAGS "$_session_group_59"
...
set _session_group_60 INPUT_STAGE_OPERANDX
gui_sg_create "$_session_group_60"
set INPUT_STAGE_OPERANDX "$_session_group_60"
...
set _session_group_61 INPUT_STAGE_OPERANDY
gui_sg_create "$_session_group_61"
set INPUT_STAGE_OPERANDY "$_session_group_61"

gui_sg_addsignal -group "$_session_group_61" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.W tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.clk tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.rst tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.load tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.D tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_STAGE_OPERANDY.Q }
...
set _session_group_62 INIT
gui_sg_create "$_session_group_62"
set INIT "$_session_group_62"

gui_sg_addsignal -group "$_session_group_62" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDX_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intDY_EWSW }

set _session_group_63 $_session_group_62|
append _session_group_63 FLAGS
gui_sg_create "$_session_group_63"
set INIT|FLAGS "$_session_group_63"

gui_sg_addsignal -group "$_session_group_63" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.intAS tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.INPUT_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.eqXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.gtXY tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_INIT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_INIT }

set _session_group_64 EXP
gui_sg_create "$_session_group_64"
set EXP "$_session_group_64"

gui_sg_addsignal -group "$_session_group_64" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_EXP_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_EXP_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_exp_EXP_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_exp_EXP_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_mant_EXP_SW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_mant_EXP_SW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Shift_amount_EXP_EW }

set _session_group_65 $_session_group_64|
append _session_group_65 Group2
gui_sg_create "$_session_group_65"
set EXP|Group2 "$_session_group_65"

gui_sg_addsignal -group "$_session_group_65" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.EXP_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_EXP tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_EXP tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_EXP }

set _session_group_66 SHT1
gui_sg_create "$_session_group_66"
set SHT1 "$_session_group_66"

gui_sg_addsignal -group "$_session_group_66" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_SHT1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT1_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_SHT1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_SHT1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_SHT1_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DmP_mant_SHT1_SW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Shift_amount_SHT1_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.shft_value_mux_o_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.left_right_SHT1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.bit_shift_SHT1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.sftr_idat_SHT1_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.sftr_odat_SHT1_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.mux_sel_norm_EWR }

set _session_group_67 SHT2
gui_sg_create "$_session_group_67"
set SHT2 "$_session_group_67"

gui_sg_addsignal -group "$_session_group_67" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_SHT2_EWSW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.shift_value_SHT2_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.sftr_idat_SHT2_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.sftr_odat_SHT2_SWR }

set _session_group_68 $_session_group_67|
append _session_group_68 FLAGS
gui_sg_create "$_session_group_68"
set SHT2|FLAGS "$_session_group_68"

gui_sg_addsignal -group "$_session_group_68" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_SHT2 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SHT2_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_SHT2 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_SHT2 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.left_right_SHT2 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.bit_shift_SHT2 }

set _session_group_69 SGF
gui_sg_create "$_session_group_69"
set SGF "$_session_group_69"
...
append _session_group_70 FLAGS
gui_sg_create "$_session_group_70"
set SGF|FLAGS "$_session_group_70"

gui_sg_addsignal -group "$_session_group_70" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OP_FLAG_SFG tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SFG_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_SFG tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_SFG tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_SGF tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Carry_out_SGF }

set _session_group_71 NRM
gui_sg_create "$_session_group_71"
set NRM "$_session_group_71"

gui_sg_addsignal -group "$_session_group_71" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_exp_NRM_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Add_Subt_LZD_SWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.Raw_mant_NRM_SWR }

set _session_group_72 $_session_group_71|
append _session_group_72 FLAGS
gui_sg_create "$_session_group_72"
set NRM|FLAGS "$_session_group_72"

gui_sg_addsignal -group "$_session_group_72" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.NRM_ACTIVE tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.SIGN_FLAG_NRM tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ZERO_FLAG_NRM }

set _session_group_73 FRMT
gui_sg_create "$_session_group_73"
set FRMT "$_session_group_73"

gui_sg_addsignal -group "$_session_group_73" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_output_NRM2_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.DMP_exp_NRM2_EW tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_NRM2_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_raw_out_EWR tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.LZD_ZFiller tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.exp_rslt_NRM2_EW1 tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.formatted_number_W }

set _session_group_74 $_session_group_73|
append _session_group_74 FLAGS
gui_sg_create "$_session_group_74"
set FRMT|FLAGS "$_session_group_74"

gui_sg_addsignal -group "$_session_group_74" { tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.OVRFLW_FLAG_FRMT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.UNDRFLW_FLAG_FRMT tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM2 }

set _session_group_75 Group12
gui_sg_create "$_session_group_75"
set Group12 "$_session_group_75"
...
catch { gui_list_select -id ${Data.1} {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM2 }}
gui_view_scroll -id ${Data.1} -vertical -set 1365
...
gui_wv_zoom_timerange -id ${Wave.1} 20631665 20758282
...
gui_list_set_insertion_bar  -id ${Wave.1} -group FRMT|FLAGS  -item tb_FPU_PIPELINED_FPADDSUB2_vector_testing.inst_uut.ADD_OVRFLW_NRM2 -position below
