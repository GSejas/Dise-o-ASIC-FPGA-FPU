...
# DVE full session
# Saved on Fri Oct 21 16:08:54 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{1 52} {678 766}}
...
gui_update_layout -id ${HSPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_hier_colhier 584} {child_hier_coltype 90} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 344} {child_data_colvalue 131} {child_data_coltype 198} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Wave.1 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.1} -show_state maximized
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 307} {child_wave_right 365} {child_wave_colname 222} {child_wave_colvalue 81} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 20694943 20695057
