...
# DVE full session
# Saved on Sat Nov 19 17:55:32 2016
# Designs open: 1
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +lint=all -a log_name +define+SINGLE +neg_tchk}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SINGLE +neg_tchk -ucligui} -dir /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_approximate/integracion_fisica/simulacion_logica_behavioral/SINGLE -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 20694881 20695119
