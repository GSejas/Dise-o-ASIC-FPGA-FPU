...
# DVE full session
# Saved on Thu Oct 20 17:41:30 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_behavioral/SINGLE/session.inter.vpd.tcl" type="Debug">
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 552} {child_data_colvalue 373} {child_data_coltype 428} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Source.1 [gui_create_window -type {Source}  -parent ${TopLevel.1}]
gui_show_window -window ${Source.1} -show_state maximized
gui_update_layout -id ${Source.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false}}
set Wave.1 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.1} -show_state maximized
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 421} {child_wave_right 933} {child_wave_colname 237} {child_wave_colvalue 180} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_open_source -id ${Source.1}  -replace -active add_sub_carry_out /home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/sources/Source_Files/FPU_Interface/fpaddsub_arch2/add_sub_carry_out.v
...
gui_wv_zoom_timerange -id ${Wave.1} 0 646720
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group1  -item {tb_FPU_PIPELINED_FPADDSUB2_vector_testing.final_result_ieee[31:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 87127
