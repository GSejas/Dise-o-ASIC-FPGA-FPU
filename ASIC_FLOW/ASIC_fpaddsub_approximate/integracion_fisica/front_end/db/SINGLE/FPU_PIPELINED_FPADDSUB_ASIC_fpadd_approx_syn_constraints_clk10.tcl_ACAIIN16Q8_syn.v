...
module FPU_PIPELINED_FPADDSUB_W32_EW8_SW23_SWR26_EWR5 ( clk, rst, beg_OP, 
  ...
  wire   Shift_reg_FLAGS_7_6, intAS, SIGN_FLAG_EXP, OP_FLAG_EXP, ZERO_FLAG_EXP,
         ...
         DP_OP_15J28_123_3372_n8, DP_OP_15J28_123_3372_n7,
         DP_OP_15J28_123_3372_n6, DP_OP_15J28_123_3372_n5,
         DP_OP_15J28_123_3372_n4, intadd_21_B_2_, intadd_21_B_1_,
         intadd_21_B_0_, intadd_21_CI, intadd_21_SUM_2_, intadd_21_SUM_1_,
         intadd_21_SUM_0_, intadd_21_n3, intadd_21_n2, intadd_21_n1,
         DP_OP_285J28_122_2126_n74, DP_OP_285J28_122_2126_n73,
         DP_OP_285J28_122_2126_n72, DP_OP_285J28_122_2126_n71,
         DP_OP_285J28_122_2126_n70, n873, n874, n875, n876, n877, n878, n879,
  ...
  CMPR32X2TS intadd_21_U4 ( .A(n1700), .B(intadd_21_B_0_), .C(intadd_21_CI), 
        .CO(intadd_21_n3), .S(intadd_21_SUM_0_) );
  CMPR32X2TS intadd_21_U3 ( .A(n1710), .B(intadd_21_B_1_), .C(intadd_21_n3), 
        .CO(intadd_21_n2), .S(intadd_21_SUM_1_) );
  CMPR32X2TS intadd_21_U2 ( .A(n1711), .B(intadd_21_B_2_), .C(intadd_21_n2), 
        .CO(intadd_21_n1), .S(intadd_21_SUM_2_) );
  AFCSIHCONX2TS DP_OP_285J28_122_2126_U78 ( .A(DMP_SFG[8]), .B(
        DmP_mant_SFG_SWR_signed[10]), .CS(DP_OP_285J28_122_2126_n74), .CO0N(
        DP_OP_285J28_122_2126_n73), .CO1N(DP_OP_285J28_122_2126_n72) );
  AFCSHCINX2TS DP_OP_285J28_122_2126_U77 ( .CI1N(DP_OP_285J28_122_2126_n72), 
        .B(DmP_mant_SFG_SWR_signed[11]), .A(DMP_SFG[9]), .CI0N(
        DP_OP_285J28_122_2126_n73), .CS(DP_OP_285J28_122_2126_n74), .CO1(
        DP_OP_285J28_122_2126_n70), .CO0(DP_OP_285J28_122_2126_n71) );
  ...
  DFFRX2TS SGF_STAGE_FLAGS_Q_reg_1_ ( .D(n549), .CK(clk), .RN(n1762), .Q(n873), 
        .QN(n1661) );
  ADDFX1TS DP_OP_15J28_123_3372_U7 ( .A(n1665), .B(DMP_exp_NRM2_EW[2]), .CI(
        DP_OP_15J28_123_3372_n7), .CO(DP_OP_15J28_123_3372_n6), .S(
        exp_rslt_NRM2_EW1[2]) );
  ADDFX1TS DP_OP_15J28_123_3372_U6 ( .A(n1663), .B(DMP_exp_NRM2_EW[3]), .CI(
        DP_OP_15J28_123_3372_n6), .CO(DP_OP_15J28_123_3372_n5), .S(
        exp_rslt_NRM2_EW1[3]) );
  DFFRX2TS NRM_STAGE_Raw_mant_Q_reg_24_ ( .D(n518), .CK(clk), .RN(n1759), .Q(
        Raw_mant_NRM_SWR[24]) );
  CMPR32X2TS DP_OP_15J28_123_3372_U8 ( .A(n1664), .B(DMP_exp_NRM2_EW[1]), .C(
        DP_OP_15J28_123_3372_n8), .CO(DP_OP_15J28_123_3372_n7), .S(
        exp_rslt_NRM2_EW1[1]) );
  CMPR32X2TS DP_OP_15J28_123_3372_U5 ( .A(n1671), .B(DMP_exp_NRM2_EW[4]), .C(
        DP_OP_15J28_123_3372_n5), .CO(DP_OP_15J28_123_3372_n4), .S(
        exp_rslt_NRM2_EW1[4]) );
  ...
  NOR2X1TS U1192 ( .A(n1117), .B(n1116), .Y(intadd_21_B_1_) );
  ...
  CLKMX2X2TS U1199 ( .A(DP_OP_285J28_122_2126_n71), .B(
        DP_OP_285J28_122_2126_n70), .S0(DP_OP_285J28_122_2126_n74), .Y(n1474)
         );
  NAND2X1TS U1200 ( .A(n1662), .B(LZD_output_NRM2_EW[0]), .Y(
        DP_OP_15J28_123_3372_n8) );
  ...
  AOI2BB2XLTS U1272 ( .B0(n1588), .B1(intadd_21_SUM_0_), .A0N(
  ...
  NOR2X1TS U1529 ( .A(n1079), .B(n1078), .Y(intadd_21_B_2_) );
  ...
  INVX2TS U1640 ( .A(DP_OP_15J28_123_3372_n4), .Y(n1061) );
  ...
  XNOR2X2TS U1644 ( .A(DMP_exp_NRM2_EW[5]), .B(DP_OP_15J28_123_3372_n4), .Y(
        n1089) );
  ...
  OAI21X1TS U1800 ( .A0(n1580), .A1(DMP_SFG[1]), .B0(n1185), .Y(intadd_21_B_0_) );
  ...
  NOR2X1TS U1812 ( .A(n1199), .B(n1198), .Y(intadd_21_CI) );
  ...
  INVX2TS U1984 ( .A(intadd_21_B_2_), .Y(n1468) );
  INVX2TS U1985 ( .A(intadd_21_B_1_), .Y(n1466) );
  INVX2TS U1986 ( .A(intadd_21_CI), .Y(n1464) );
  ...
  AOI22X1TS U2062 ( .A0(n1588), .A1(intadd_21_SUM_1_), .B0(n1654), .B1(n989), 
        .Y(n537) );
  AOI22X1TS U2063 ( .A0(n1588), .A1(intadd_21_SUM_2_), .B0(n1702), .B1(n989), 
        .Y(n536) );
  XOR2X1TS U2064 ( .A(n1585), .B(DMP_SFG[5]), .Y(n1586) );
  XOR2X1TS U2065 ( .A(intadd_21_n1), .B(n1586), .Y(n1587) );
...
initial $sdf_annotate("FPU_PIPELINED_FPADDSUB_ASIC_fpadd_approx_syn_constraints_clk10.tcl_ACAIIN16Q8_syn.sdf"); 
 endmodule
