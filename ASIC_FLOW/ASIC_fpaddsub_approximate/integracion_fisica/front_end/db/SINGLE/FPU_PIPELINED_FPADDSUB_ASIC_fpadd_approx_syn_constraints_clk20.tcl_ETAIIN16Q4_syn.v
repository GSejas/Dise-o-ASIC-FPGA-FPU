...
module FPU_PIPELINED_FPADDSUB_W32_EW8_SW23_SWR26_EWR5 ( clk, rst, beg_OP, 
  ...
  wire   n1725, Shift_reg_FLAGS_7_6, intAS, SIGN_FLAG_EXP, OP_FLAG_EXP,
         ...
         n917, n918, n919, n920, n921, n922, DP_OP_15J14_123_4261_n8,
         DP_OP_15J14_123_4261_n7, DP_OP_15J14_123_4261_n6,
         DP_OP_15J14_123_4261_n5, DP_OP_15J14_123_4261_n4, intadd_6_B_10_,
         ...
         intadd_6_n4, intadd_6_n3, intadd_6_n2, intadd_6_n1, n923, n924, n925,
         ...
         n1555, n1556, n1557, n1558, n1560, n1561, n1562, n1563, n1564, n1566,
  ...
  DFFRXLTS SGF_STAGE_DmP_mant_Q_reg_25_ ( .D(n514), .CK(clk), .RN(n1694), .Q(
        DmP_mant_SFG_SWR[25]) );
  CMPR32X2TS intadd_6_U12 ( .A(n1631), .B(intadd_6_B_0_), .C(intadd_6_CI), 
        .CO(intadd_6_n11), .S(intadd_6_SUM_0_) );
  CMPR32X2TS intadd_6_U11 ( .A(n1630), .B(intadd_6_B_1_), .C(intadd_6_n11), 
        .CO(intadd_6_n10), .S(intadd_6_SUM_1_) );
  CMPR32X2TS intadd_6_U10 ( .A(n1636), .B(intadd_6_B_2_), .C(intadd_6_n10), 
        .CO(intadd_6_n9), .S(intadd_6_SUM_2_) );
  CMPR32X2TS intadd_6_U9 ( .A(n1653), .B(intadd_6_B_3_), .C(intadd_6_n9), .CO(
        intadd_6_n8), .S(intadd_6_SUM_3_) );
  CMPR32X2TS intadd_6_U8 ( .A(n1652), .B(intadd_6_B_4_), .C(intadd_6_n8), .CO(
        intadd_6_n7), .S(intadd_6_SUM_4_) );
  CMPR32X2TS intadd_6_U7 ( .A(n1665), .B(intadd_6_B_5_), .C(intadd_6_n7), .CO(
        intadd_6_n6), .S(intadd_6_SUM_5_) );
  CMPR32X2TS intadd_6_U6 ( .A(n1664), .B(intadd_6_B_6_), .C(intadd_6_n6), .CO(
        intadd_6_n5), .S(intadd_6_SUM_6_) );
  CMPR32X2TS intadd_6_U5 ( .A(n1674), .B(intadd_6_B_7_), .C(intadd_6_n5), .CO(
        intadd_6_n4), .S(intadd_6_SUM_7_) );
  CMPR32X2TS intadd_6_U4 ( .A(n1673), .B(intadd_6_B_8_), .C(intadd_6_n4), .CO(
        intadd_6_n3), .S(intadd_6_SUM_8_) );
  CMPR32X2TS intadd_6_U3 ( .A(n1686), .B(intadd_6_B_9_), .C(intadd_6_n3), .CO(
        intadd_6_n2), .S(intadd_6_SUM_9_) );
  CMPR32X2TS intadd_6_U2 ( .A(n1685), .B(intadd_6_B_10_), .C(intadd_6_n2), 
        .CO(intadd_6_n1), .S(intadd_6_SUM_10_) );
  ...
  ADDFX1TS DP_OP_15J14_123_4261_U8 ( .A(n1623), .B(DMP_exp_NRM2_EW[1]), .CI(
        DP_OP_15J14_123_4261_n8), .CO(DP_OP_15J14_123_4261_n7), .S(
        exp_rslt_NRM2_EW1[1]) );
  ADDFX1TS DP_OP_15J14_123_4261_U7 ( .A(n1633), .B(DMP_exp_NRM2_EW[2]), .CI(
        DP_OP_15J14_123_4261_n7), .CO(DP_OP_15J14_123_4261_n6), .S(
        exp_rslt_NRM2_EW1[2]) );
  ADDFX1TS DP_OP_15J14_123_4261_U6 ( .A(n1632), .B(DMP_exp_NRM2_EW[3]), .CI(
        DP_OP_15J14_123_4261_n6), .CO(DP_OP_15J14_123_4261_n5), .S(
        exp_rslt_NRM2_EW1[3]) );
  ADDFX1TS DP_OP_15J14_123_4261_U5 ( .A(n1637), .B(DMP_exp_NRM2_EW[4]), .CI(
        DP_OP_15J14_123_4261_n5), .CO(DP_OP_15J14_123_4261_n4), .S(
        exp_rslt_NRM2_EW1[4]) );
  ...
  AOI2BB2XLTS U1032 ( .B0(DmP_mant_SFG_SWR[18]), .B1(n1419), .A0N(n1627), 
        .A1N(DmP_mant_SFG_SWR[18]), .Y(intadd_6_B_4_) );
  AOI2BB2XLTS U1033 ( .B0(DmP_mant_SFG_SWR[19]), .B1(n1419), .A0N(n1461), 
        .A1N(DmP_mant_SFG_SWR[19]), .Y(intadd_6_B_5_) );
  ...
  AOI2BB2XLTS U1036 ( .B0(DmP_mant_SFG_SWR[23]), .B1(n1419), .A0N(n1419), 
        .A1N(DmP_mant_SFG_SWR[23]), .Y(intadd_6_B_9_) );
  AOI2BB2XLTS U1037 ( .B0(DmP_mant_SFG_SWR[22]), .B1(n1419), .A0N(n1461), 
        .A1N(DmP_mant_SFG_SWR[22]), .Y(intadd_6_B_8_) );
  ...
  AOI2BB2XLTS U1042 ( .B0(DmP_mant_SFG_SWR[16]), .B1(n1419), .A0N(n1627), 
        .A1N(DmP_mant_SFG_SWR[16]), .Y(intadd_6_B_2_) );
  ...
  AO22XLTS U1106 ( .A0(n1571), .A1(DMP_SHT2_EWSW[10]), .B0(n1581), .B1(
        DMP_SFG[10]), .Y(n738) );
  AOI2BB2XLTS U1107 ( .B0(n1480), .B1(intadd_6_SUM_4_), .A0N(
  ...
  AOI2BB2XLTS U1110 ( .B0(n1480), .B1(intadd_6_SUM_1_), .A0N(
        Raw_mant_NRM_SWR[15]), .A1N(n1480), .Y(n592) );
  AOI2BB2XLTS U1111 ( .B0(n1480), .B1(intadd_6_SUM_5_), .A0N(
  ...
  AOI2BB2XLTS U1122 ( .B0(n1480), .B1(intadd_6_SUM_6_), .A0N(
  ...
  OAI21XLTS U1306 ( .A0(DMP_SFG[11]), .A1(n1427), .B0(n1118), .Y(intadd_6_B_0_) );
  ...
  XNOR2X2TS U1324 ( .A(DMP_exp_NRM2_EW[5]), .B(DP_OP_15J14_123_4261_n4), .Y(
        n1306) );
  ...
  INVX2TS U1478 ( .A(DP_OP_15J14_123_4261_n4), .Y(n1036) );
  ...
  NAND2X1TS U1684 ( .A(n1622), .B(n1317), .Y(DP_OP_15J14_123_4261_n8) );
