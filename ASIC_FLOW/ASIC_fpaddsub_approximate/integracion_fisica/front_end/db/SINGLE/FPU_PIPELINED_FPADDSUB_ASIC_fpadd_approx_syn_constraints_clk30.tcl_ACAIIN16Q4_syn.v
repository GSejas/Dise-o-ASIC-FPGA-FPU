...
module FPU_PIPELINED_FPADDSUB_W32_EW8_SW23_SWR26_EWR5 ( clk, rst, beg_OP, 
  ...
  wire   Shift_reg_FLAGS_7_6, intAS, SIGN_FLAG_EXP, OP_FLAG_EXP, ZERO_FLAG_EXP,
         ...
         DP_OP_15J25_123_2314_n8, DP_OP_15J25_123_2314_n7,
         DP_OP_15J25_123_2314_n6, DP_OP_15J25_123_2314_n5,
         DP_OP_15J25_123_2314_n4, intadd_19_B_10_, intadd_19_B_9_,
         intadd_19_B_8_, intadd_19_B_7_, intadd_19_B_6_, intadd_19_B_5_,
         intadd_19_B_4_, intadd_19_B_3_, intadd_19_B_2_, intadd_19_B_1_,
         intadd_19_B_0_, intadd_19_CI, intadd_19_SUM_10_, intadd_19_SUM_9_,
         intadd_19_SUM_8_, intadd_19_SUM_7_, intadd_19_SUM_6_,
         intadd_19_SUM_5_, intadd_19_SUM_4_, intadd_19_SUM_3_,
         intadd_19_SUM_2_, intadd_19_SUM_1_, intadd_19_SUM_0_, intadd_19_n11,
  ...
  DFFRXLTS SGF_STAGE_DmP_mant_Q_reg_25_ ( .D(n514), .CK(clk), .RN(n1698), .Q(
        DmP_mant_SFG_SWR[25]) );
  CMPR32X2TS intadd_19_U12 ( .A(n1608), .B(intadd_19_B_0_), .C(intadd_19_CI), 
        .CO(intadd_19_n11), .S(intadd_19_SUM_0_) );
  CMPR32X2TS intadd_19_U11 ( .A(n1612), .B(intadd_19_B_1_), .C(intadd_19_n11), 
        .CO(intadd_19_n10), .S(intadd_19_SUM_1_) );
  CMPR32X2TS intadd_19_U10 ( .A(n1611), .B(intadd_19_B_2_), .C(intadd_19_n10), 
        .CO(intadd_19_n9), .S(intadd_19_SUM_2_) );
  CMPR32X2TS intadd_19_U9 ( .A(n1620), .B(intadd_19_B_3_), .C(intadd_19_n9), 
        .CO(intadd_19_n8), .S(intadd_19_SUM_3_) );
  CMPR32X2TS intadd_19_U8 ( .A(n1641), .B(intadd_19_B_4_), .C(intadd_19_n8), 
        .CO(intadd_19_n7), .S(intadd_19_SUM_4_) );
  CMPR32X2TS intadd_19_U7 ( .A(n1640), .B(intadd_19_B_5_), .C(intadd_19_n7), 
        .CO(intadd_19_n6), .S(intadd_19_SUM_5_) );
  CMPR32X2TS intadd_19_U6 ( .A(n1651), .B(intadd_19_B_6_), .C(intadd_19_n6), 
        .CO(intadd_19_n5), .S(intadd_19_SUM_6_) );
  CMPR32X2TS intadd_19_U5 ( .A(n1650), .B(intadd_19_B_7_), .C(intadd_19_n5), 
        .CO(intadd_19_n4), .S(intadd_19_SUM_7_) );
  CMPR32X2TS intadd_19_U4 ( .A(n1662), .B(intadd_19_B_8_), .C(intadd_19_n4), 
        .CO(intadd_19_n3), .S(intadd_19_SUM_8_) );
  CMPR32X2TS intadd_19_U3 ( .A(n1661), .B(intadd_19_B_9_), .C(intadd_19_n3), 
        .CO(intadd_19_n2), .S(intadd_19_SUM_9_) );
  CMPR32X2TS intadd_19_U2 ( .A(n1666), .B(intadd_19_B_10_), .C(intadd_19_n2), 
        .CO(intadd_19_n1), .S(intadd_19_SUM_10_) );
  ...
  DFFRX2TS inst_ShiftRegister_Q_reg_5_ ( .D(n919), .CK(clk), .RN(n1672), .Q(
        n1568), .QN(n1665) );
  ADDFX1TS DP_OP_15J25_123_2314_U8 ( .A(n1599), .B(DMP_exp_NRM2_EW[1]), .CI(
        DP_OP_15J25_123_2314_n8), .CO(DP_OP_15J25_123_2314_n7), .S(
        exp_rslt_NRM2_EW1[1]) );
  ADDFX1TS DP_OP_15J25_123_2314_U7 ( .A(n1609), .B(DMP_exp_NRM2_EW[2]), .CI(
        DP_OP_15J25_123_2314_n7), .CO(DP_OP_15J25_123_2314_n6), .S(
        exp_rslt_NRM2_EW1[2]) );
  ADDFX1TS DP_OP_15J25_123_2314_U6 ( .A(n1614), .B(DMP_exp_NRM2_EW[3]), .CI(
        DP_OP_15J25_123_2314_n6), .CO(DP_OP_15J25_123_2314_n5), .S(
        exp_rslt_NRM2_EW1[3]) );
  ADDFX1TS DP_OP_15J25_123_2314_U5 ( .A(n1613), .B(DMP_exp_NRM2_EW[4]), .CI(
        DP_OP_15J25_123_2314_n5), .CO(DP_OP_15J25_123_2314_n4), .S(
        exp_rslt_NRM2_EW1[4]) );
  ...
  XNOR2X2TS U1083 ( .A(DMP_exp_NRM2_EW[5]), .B(DP_OP_15J25_123_2314_n4), .Y(
        n1013) );
  ...
  OAI21XLTS U1112 ( .A0(DMP_SFG[11]), .A1(n1412), .B0(n1164), .Y(
        intadd_19_B_0_) );
  ...
  AO22XLTS U1245 ( .A0(n1487), .A1(DmP_mant_SFG_SWR[18]), .B0(n1486), .B1(
        n1526), .Y(n521) );
  INVX2TS U1246 ( .A(DP_OP_15J25_123_2314_n4), .Y(n995) );
  ...
  NAND2X1TS U1567 ( .A(n1598), .B(n1296), .Y(DP_OP_15J25_123_2314_n8) );
  ...
  AOI22X1TS U1834 ( .A0(n927), .A1(n1544), .B0(DmP_mant_SFG_SWR[14]), .B1(
        n1437), .Y(intadd_19_CI) );
  AOI22X1TS U1835 ( .A0(n1499), .A1(intadd_19_SUM_0_), .B0(n1589), .B1(n1497), 
        .Y(n593) );
  INVX1TS U1836 ( .A(DmP_mant_SFG_SWR[15]), .Y(n1546) );
  AOI22X1TS U1837 ( .A0(n1439), .A1(n1546), .B0(DmP_mant_SFG_SWR[15]), .B1(
        n1437), .Y(intadd_19_B_1_) );
  AOI2BB2XLTS U1838 ( .B0(n1470), .B1(intadd_19_SUM_1_), .A0N(
        Raw_mant_NRM_SWR[15]), .A1N(n1587), .Y(n592) );
  AOI2BB2XLTS U1839 ( .B0(DmP_mant_SFG_SWR[16]), .B1(n1437), .A0N(n1404), 
        .A1N(DmP_mant_SFG_SWR[16]), .Y(intadd_19_B_2_) );
  AOI22X1TS U1840 ( .A0(n1499), .A1(intadd_19_SUM_2_), .B0(n1644), .B1(n1497), 
        .Y(n591) );
  INVX1TS U1841 ( .A(DmP_mant_SFG_SWR[17]), .Y(n1549) );
  AOI22X1TS U1842 ( .A0(n927), .A1(n1549), .B0(DmP_mant_SFG_SWR[17]), .B1(
        n1404), .Y(intadd_19_B_3_) );
  AOI22X1TS U1843 ( .A0(n1499), .A1(intadd_19_SUM_3_), .B0(n1610), .B1(n1497), 
        .Y(n590) );
  AOI2BB2XLTS U1844 ( .B0(DmP_mant_SFG_SWR[18]), .B1(n1437), .A0N(n1404), 
        .A1N(DmP_mant_SFG_SWR[18]), .Y(intadd_19_B_4_) );
  AOI2BB2XLTS U1845 ( .B0(n1470), .B1(intadd_19_SUM_4_), .A0N(
        Raw_mant_NRM_SWR[18]), .A1N(n1470), .Y(n589) );
  AOI2BB2XLTS U1846 ( .B0(DmP_mant_SFG_SWR[19]), .B1(n1437), .A0N(n1404), 
        .A1N(DmP_mant_SFG_SWR[19]), .Y(intadd_19_B_5_) );
  AOI2BB2XLTS U1847 ( .B0(n1470), .B1(intadd_19_SUM_5_), .A0N(
        Raw_mant_NRM_SWR[19]), .A1N(n1587), .Y(n588) );
  AOI22X1TS U1848 ( .A0(n927), .A1(n935), .B0(DmP_mant_SFG_SWR[20]), .B1(n1404), .Y(intadd_19_B_6_) );
  AOI2BB2XLTS U1849 ( .B0(n1470), .B1(intadd_19_SUM_6_), .A0N(
        Raw_mant_NRM_SWR[20]), .A1N(n1587), .Y(n587) );
  AOI22X1TS U1850 ( .A0(n1439), .A1(n936), .B0(DmP_mant_SFG_SWR[21]), .B1(
        n1404), .Y(intadd_19_B_7_) );
  AOI22X1TS U1851 ( .A0(n1470), .A1(intadd_19_SUM_7_), .B0(n1603), .B1(n1497), 
        .Y(n586) );
  AOI2BB2XLTS U1852 ( .B0(DmP_mant_SFG_SWR[22]), .B1(n1437), .A0N(n1437), 
        .A1N(DmP_mant_SFG_SWR[22]), .Y(intadd_19_B_8_) );
  AOI22X1TS U1853 ( .A0(n1470), .A1(intadd_19_SUM_8_), .B0(n1564), .B1(n1497), 
        .Y(n585) );
  AOI2BB2XLTS U1854 ( .B0(DmP_mant_SFG_SWR[23]), .B1(n1437), .A0N(n1404), 
        .A1N(DmP_mant_SFG_SWR[23]), .Y(intadd_19_B_9_) );
  AOI22X1TS U1855 ( .A0(n1499), .A1(intadd_19_SUM_9_), .B0(n968), .B1(n1497), 
        .Y(n584) );
  INVX1TS U1856 ( .A(DmP_mant_SFG_SWR[24]), .Y(n1554) );
  AOI22X1TS U1857 ( .A0(n1439), .A1(n1554), .B0(DmP_mant_SFG_SWR[24]), .B1(
        n1437), .Y(intadd_19_B_10_) );
  AOI22X1TS U1858 ( .A0(n1499), .A1(intadd_19_SUM_10_), .B0(n1563), .B1(n1497), 
        .Y(n583) );
  INVX1TS U1859 ( .A(DmP_mant_SFG_SWR[25]), .Y(n1560) );
  AOI22X1TS U1860 ( .A0(n1439), .A1(DmP_mant_SFG_SWR[25]), .B0(n1560), .B1(
        n1437), .Y(n1405) );
  XNOR2X1TS U1861 ( .A(intadd_19_n1), .B(n1405), .Y(n1406) );
...
initial $sdf_annotate("FPU_PIPELINED_FPADDSUB_ASIC_fpadd_approx_syn_constraints_clk30.tcl_ACAIIN16Q4_syn.sdf"); 
 endmodule
