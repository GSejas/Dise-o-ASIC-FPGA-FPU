...
module FPU_PIPELINED_FPADDSUB_W32_EW8_SW23_SWR26_EWR5 ( clk, rst, beg_OP, 
  ...
  wire   n1892, Shift_reg_FLAGS_7_6, intAS, SIGN_FLAG_EXP, OP_FLAG_EXP,
         ...
         DP_OP_15J6_122_6956_n18, DP_OP_15J6_122_6956_n17,
         DP_OP_15J6_122_6956_n16, DP_OP_15J6_122_6956_n15,
         DP_OP_15J6_122_6956_n14, DP_OP_15J6_122_6956_n8,
         DP_OP_15J6_122_6956_n7, DP_OP_15J6_122_6956_n6,
         DP_OP_15J6_122_6956_n5, DP_OP_15J6_122_6956_n4,
         DP_OP_15J6_122_6956_n3, DP_OP_15J6_122_6956_n2,
         DP_OP_15J6_122_6956_n1, n955, n957, n958, n959, n960, n961, n962,
  ...
  ADDFX1TS DP_OP_15J6_122_6956_U9 ( .A(DMP_exp_NRM2_EW[0]), .B(n1764), .CI(
        DP_OP_15J6_122_6956_n18), .CO(DP_OP_15J6_122_6956_n8), .S(
        exp_rslt_NRM2_EW1[0]) );
  ADDFX1TS DP_OP_15J6_122_6956_U8 ( .A(DP_OP_15J6_122_6956_n17), .B(
        DMP_exp_NRM2_EW[1]), .CI(DP_OP_15J6_122_6956_n8), .CO(
        DP_OP_15J6_122_6956_n7), .S(exp_rslt_NRM2_EW1[1]) );
  ADDFX1TS DP_OP_15J6_122_6956_U7 ( .A(DP_OP_15J6_122_6956_n16), .B(
        DMP_exp_NRM2_EW[2]), .CI(DP_OP_15J6_122_6956_n7), .CO(
        DP_OP_15J6_122_6956_n6), .S(exp_rslt_NRM2_EW1[2]) );
  ADDFX1TS DP_OP_15J6_122_6956_U5 ( .A(DP_OP_15J6_122_6956_n14), .B(
        DMP_exp_NRM2_EW[4]), .CI(DP_OP_15J6_122_6956_n5), .CO(
        DP_OP_15J6_122_6956_n4), .S(exp_rslt_NRM2_EW1[4]) );
  ADDFX1TS DP_OP_15J6_122_6956_U4 ( .A(n1764), .B(DMP_exp_NRM2_EW[5]), .CI(
        DP_OP_15J6_122_6956_n4), .CO(DP_OP_15J6_122_6956_n3), .S(
        exp_rslt_NRM2_EW1[5]) );
  DFFRX4TS inst_ShiftRegister_Q_reg_1_ ( .D(n945), .CK(clk), .RN(n1855), .Q(
        Shift_reg_FLAGS_7[1]) );
  CMPR32X2TS DP_OP_15J6_122_6956_U6 ( .A(DP_OP_15J6_122_6956_n15), .B(
        DMP_exp_NRM2_EW[3]), .C(DP_OP_15J6_122_6956_n6), .CO(
        DP_OP_15J6_122_6956_n5), .S(exp_rslt_NRM2_EW1[3]) );
  DFFRX4TS SHT2_STAGE_SHFTVARS2_Q_reg_1_ ( .D(n877), .CK(clk), .RN(n1879), .Q(
        left_right_SHT2), .QN(n979) );
  CMPR32X2TS DP_OP_15J6_122_6956_U3 ( .A(n1764), .B(DMP_exp_NRM2_EW[6]), .C(
        DP_OP_15J6_122_6956_n3), .CO(DP_OP_15J6_122_6956_n2), .S(
        exp_rslt_NRM2_EW1[6]) );
  CMPR32X2TS DP_OP_15J6_122_6956_U2 ( .A(n1764), .B(DMP_exp_NRM2_EW[7]), .C(
        DP_OP_15J6_122_6956_n2), .CO(DP_OP_15J6_122_6956_n1), .S(
        exp_rslt_NRM2_EW1[7]) );
  ...
  XNOR2X1TS U1442 ( .A(DP_OP_15J6_122_6956_n1), .B(ADD_OVRFLW_NRM2), .Y(n1376)
         );
  ...
  XOR2X1TS U1680 ( .A(n1764), .B(n1379), .Y(DP_OP_15J6_122_6956_n14) );
  NOR2BX1TS U1681 ( .AN(LZD_output_NRM2_EW[3]), .B(ADD_OVRFLW_NRM2), .Y(n1380)
         );
  XOR2X1TS U1682 ( .A(n1764), .B(n1380), .Y(DP_OP_15J6_122_6956_n15) );
  NOR2BX1TS U1683 ( .AN(LZD_output_NRM2_EW[2]), .B(ADD_OVRFLW_NRM2), .Y(n1381)
         );
  XOR2X1TS U1684 ( .A(n1764), .B(n1381), .Y(DP_OP_15J6_122_6956_n16) );
  NOR2BX1TS U1685 ( .AN(LZD_output_NRM2_EW[1]), .B(ADD_OVRFLW_NRM2), .Y(n1382)
         );
  XOR2X1TS U1686 ( .A(n1764), .B(n1382), .Y(DP_OP_15J6_122_6956_n17) );
  XOR2X1TS U1687 ( .A(n1764), .B(n1383), .Y(DP_OP_15J6_122_6956_n18) );
