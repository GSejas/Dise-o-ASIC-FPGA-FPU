...
module FPU_PIPELINED_FPADDSUB_W32_EW8_SW23_SWR26_EWR5 ( clk, rst, beg_OP, 
  ...
  wire   Shift_reg_FLAGS_7_6, intAS, SIGN_FLAG_EXP, OP_FLAG_EXP, ZERO_FLAG_EXP,
         ...
         DP_OP_15J50_123_3372_n8, DP_OP_15J50_123_3372_n7,
         DP_OP_15J50_123_3372_n6, DP_OP_15J50_123_3372_n5,
         DP_OP_15J50_123_3372_n4, intadd_54_B_12_, intadd_54_B_11_,
         intadd_54_B_10_, intadd_54_B_9_, intadd_54_B_8_, intadd_54_B_7_,
         intadd_54_B_6_, intadd_54_B_5_, intadd_54_B_4_, intadd_54_B_3_,
         intadd_54_B_2_, intadd_54_B_1_, intadd_54_B_0_, intadd_54_CI,
         intadd_54_SUM_12_, intadd_54_SUM_11_, intadd_54_SUM_10_,
         ...
         intadd_54_SUM_0_, intadd_54_n13, intadd_54_n12, intadd_54_n11,
         intadd_54_n10, intadd_54_n9, intadd_54_n8, intadd_54_n7, intadd_54_n6,
         intadd_54_n5, intadd_54_n4, intadd_54_n3, intadd_54_n2, intadd_54_n1,
         intadd_55_A_2_, intadd_55_A_1_, intadd_55_B_2_, intadd_55_B_1_,
         intadd_55_B_0_, intadd_55_CI, intadd_55_SUM_2_, intadd_55_SUM_1_,
         intadd_55_SUM_0_, intadd_55_n3, intadd_55_n2, intadd_55_n1,
         intadd_56_A_2_, intadd_56_A_1_, intadd_56_B_1_, intadd_56_B_0_,
         intadd_56_CI, intadd_56_SUM_2_, intadd_56_SUM_1_, intadd_56_SUM_0_,
         intadd_56_n3, intadd_56_n2, intadd_56_n1, n872, n873, n874, n875,
  ...
  CMPR32X2TS intadd_54_U14 ( .A(n1520), .B(intadd_54_B_0_), .C(intadd_54_CI), 
        .CO(intadd_54_n13), .S(intadd_54_SUM_0_) );
  CMPR32X2TS intadd_54_U13 ( .A(n1526), .B(intadd_54_B_1_), .C(intadd_54_n13), 
        .CO(intadd_54_n12), .S(intadd_54_SUM_1_) );
  CMPR32X2TS intadd_54_U12 ( .A(n1525), .B(intadd_54_B_2_), .C(intadd_54_n12), 
        .CO(intadd_54_n11), .S(intadd_54_SUM_2_) );
  CMPR32X2TS intadd_54_U11 ( .A(n1531), .B(intadd_54_B_3_), .C(intadd_54_n11), 
        .CO(intadd_54_n10), .S(intadd_54_SUM_3_) );
  CMPR32X2TS intadd_54_U10 ( .A(n1530), .B(intadd_54_B_4_), .C(intadd_54_n10), 
        .CO(intadd_54_n9), .S(intadd_54_SUM_4_) );
  CMPR32X2TS intadd_54_U9 ( .A(n1537), .B(intadd_54_B_5_), .C(intadd_54_n9), 
        .CO(intadd_54_n8), .S(intadd_54_SUM_5_) );
  CMPR32X2TS intadd_54_U8 ( .A(n1559), .B(intadd_54_B_6_), .C(intadd_54_n8), 
        .CO(intadd_54_n7), .S(intadd_54_SUM_6_) );
  CMPR32X2TS intadd_54_U7 ( .A(n1558), .B(intadd_54_B_7_), .C(intadd_54_n7), 
        .CO(intadd_54_n6), .S(intadd_54_SUM_7_) );
  CMPR32X2TS intadd_54_U6 ( .A(n1566), .B(intadd_54_B_8_), .C(intadd_54_n6), 
        .CO(intadd_54_n5), .S(intadd_54_SUM_8_) );
  CMPR32X2TS intadd_54_U5 ( .A(n1565), .B(intadd_54_B_9_), .C(intadd_54_n5), 
        .CO(intadd_54_n4), .S(intadd_54_SUM_9_) );
  CMPR32X2TS intadd_54_U4 ( .A(n1574), .B(intadd_54_B_10_), .C(intadd_54_n4), 
        .CO(intadd_54_n3), .S(intadd_54_SUM_10_) );
  CMPR32X2TS intadd_54_U3 ( .A(n1573), .B(intadd_54_B_11_), .C(intadd_54_n3), 
        .CO(intadd_54_n2), .S(intadd_54_SUM_11_) );
  CMPR32X2TS intadd_54_U2 ( .A(n1578), .B(intadd_54_B_12_), .C(intadd_54_n2), 
        .CO(intadd_54_n1), .S(intadd_54_SUM_12_) );
  CMPR32X2TS intadd_55_U4 ( .A(n1563), .B(intadd_55_B_0_), .C(intadd_55_CI), 
        .CO(intadd_55_n3), .S(intadd_55_SUM_0_) );
  CMPR32X2TS intadd_55_U3 ( .A(intadd_55_A_1_), .B(intadd_55_B_1_), .C(
        intadd_55_n3), .CO(intadd_55_n2), .S(intadd_55_SUM_1_) );
  CMPR32X2TS intadd_55_U2 ( .A(intadd_55_A_2_), .B(intadd_55_B_2_), .C(
        intadd_55_n2), .CO(intadd_55_n1), .S(intadd_55_SUM_2_) );
  CMPR32X2TS intadd_56_U4 ( .A(n1562), .B(intadd_56_B_0_), .C(intadd_56_CI), 
        .CO(intadd_56_n3), .S(intadd_56_SUM_0_) );
  CMPR32X2TS intadd_56_U3 ( .A(intadd_56_A_1_), .B(intadd_56_B_1_), .C(
        intadd_56_n3), .CO(intadd_56_n2), .S(intadd_56_SUM_1_) );
  CMPR32X2TS intadd_56_U2 ( .A(intadd_56_A_2_), .B(n897), .C(intadd_56_n2), 
        .CO(intadd_56_n1), .S(intadd_56_SUM_2_) );
  ...
  DFFRX2TS inst_ShiftRegister_Q_reg_5_ ( .D(n868), .CK(clk), .RN(n1583), .Q(
        n1494), .QN(n1577) );
  ADDFX1TS DP_OP_15J50_123_3372_U8 ( .A(n1527), .B(DMP_exp_NRM2_EW[1]), .CI(
        DP_OP_15J50_123_3372_n8), .CO(DP_OP_15J50_123_3372_n7), .S(
        exp_rslt_NRM2_EW1[1]) );
  ADDFX1TS DP_OP_15J50_123_3372_U7 ( .A(n1528), .B(DMP_exp_NRM2_EW[2]), .CI(
        DP_OP_15J50_123_3372_n7), .CO(DP_OP_15J50_123_3372_n6), .S(
        exp_rslt_NRM2_EW1[2]) );
  ADDFX1TS DP_OP_15J50_123_3372_U6 ( .A(n1532), .B(DMP_exp_NRM2_EW[3]), .CI(
        DP_OP_15J50_123_3372_n6), .CO(DP_OP_15J50_123_3372_n5), .S(
        exp_rslt_NRM2_EW1[3]) );
  ADDFX1TS DP_OP_15J50_123_3372_U5 ( .A(n1538), .B(DMP_exp_NRM2_EW[4]), .CI(
        DP_OP_15J50_123_3372_n5), .CO(DP_OP_15J50_123_3372_n4), .S(
        exp_rslt_NRM2_EW1[4]) );
  ...
  AOI222X1TS U941 ( .A0(n1228), .A1(DMP_SFG[1]), .B0(n1228), .B1(n894), .C0(
        DMP_SFG[1]), .C1(n894), .Y(intadd_56_CI) );
  ...
  XNOR2X2TS U1036 ( .A(DMP_exp_NRM2_EW[5]), .B(DP_OP_15J50_123_3372_n4), .Y(
        n944) );
  ...
  INVX1TS U1073 ( .A(DMP_SFG[3]), .Y(intadd_56_A_1_) );
  INVX1TS U1074 ( .A(DMP_SFG[4]), .Y(intadd_56_A_2_) );
  INVX1TS U1075 ( .A(DMP_SFG[7]), .Y(intadd_55_A_1_) );
  INVX1TS U1076 ( .A(DMP_SFG[8]), .Y(intadd_55_A_2_) );
  ...
  AOI2BB2X2TS U1086 ( .B0(DmP_mant_SFG_SWR[10]), .B1(n1358), .A0N(n1358), 
        .A1N(DmP_mant_SFG_SWR[10]), .Y(intadd_55_B_2_) );
  ...
  AOI222X4TS U1098 ( .A0(DMP_SFG[5]), .A1(n895), .B0(DMP_SFG[5]), .B1(n1233), 
        .C0(n895), .C1(n1233), .Y(intadd_55_CI) );
  AOI222X4TS U1099 ( .A0(DMP_SFG[9]), .A1(n1350), .B0(DMP_SFG[9]), .B1(n1236), 
        .C0(n1350), .C1(n1236), .Y(intadd_54_B_0_) );
  ...
  AOI22X2TS U1108 ( .A0(DmP_mant_SFG_SWR[9]), .A1(n1355), .B0(n1354), .B1(n891), .Y(intadd_55_B_1_) );
  AOI22X2TS U1109 ( .A0(DmP_mant_SFG_SWR[5]), .A1(n1355), .B0(n1354), .B1(n892), .Y(intadd_56_B_1_) );
  ...
  INVX2TS U1154 ( .A(DP_OP_15J50_123_3372_n4), .Y(n926) );
  ...
  AOI22X1TS U1474 ( .A0(DmP_mant_SFG_SWR[4]), .A1(n1358), .B0(n1354), .B1(n917), .Y(intadd_56_B_0_) );
  AOI21X1TS U1475 ( .A0(intadd_56_A_1_), .A1(intadd_56_B_1_), .B0(
        intadd_56_B_0_), .Y(n1231) );
  AOI2BB2X1TS U1476 ( .B0(DMP_SFG[2]), .B1(n1231), .A0N(intadd_56_A_1_), .A1N(
        intadd_56_B_1_), .Y(n1232) );
  AOI222X1TS U1477 ( .A0(n1232), .A1(intadd_56_A_2_), .B0(n1232), .B1(n897), 
        .C0(intadd_56_A_2_), .C1(n897), .Y(n1233) );
  AOI22X1TS U1478 ( .A0(DmP_mant_SFG_SWR[8]), .A1(n1355), .B0(n1354), .B1(n920), .Y(intadd_55_B_0_) );
  AOI21X1TS U1479 ( .A0(intadd_55_A_1_), .A1(intadd_55_B_1_), .B0(
        intadd_55_B_0_), .Y(n1234) );
  AOI2BB2X1TS U1480 ( .B0(DMP_SFG[6]), .B1(n1234), .A0N(intadd_55_A_1_), .A1N(
        intadd_55_B_1_), .Y(n1235) );
  AOI222X1TS U1481 ( .A0(n1235), .A1(intadd_55_A_2_), .B0(n1235), .B1(
        intadd_55_B_2_), .C0(intadd_55_A_2_), .C1(intadd_55_B_2_), .Y(n1236)
         );
  INVX2TS U1482 ( .A(n1237), .Y(n1238) );
  NAND2X1TS U1483 ( .A(n1519), .B(n1238), .Y(DP_OP_15J50_123_3372_n8) );
  ...
  AOI2BB2XLTS U1768 ( .B0(n924), .B1(intadd_56_SUM_0_), .A0N(
        Raw_mant_NRM_SWR[4]), .A1N(n1353), .Y(n538) );
  AOI22X1TS U1769 ( .A0(n924), .A1(intadd_56_SUM_1_), .B0(n1522), .B1(n1361), 
        .Y(n537) );
  AOI22X1TS U1770 ( .A0(n924), .A1(intadd_56_SUM_2_), .B0(n1493), .B1(n1361), 
        .Y(n536) );
  XNOR2X1TS U1771 ( .A(DMP_SFG[5]), .B(n895), .Y(n1348) );
  XNOR2X1TS U1772 ( .A(intadd_56_n1), .B(n1348), .Y(n1349) );
  AOI22X1TS U1773 ( .A0(n1357), .A1(n1349), .B0(n1488), .B1(n1361), .Y(n535)
         );
  AOI22X1TS U1774 ( .A0(n1357), .A1(intadd_55_SUM_0_), .B0(n1490), .B1(n1361), 
        .Y(n534) );
  AOI22X1TS U1775 ( .A0(n924), .A1(intadd_55_SUM_1_), .B0(n1492), .B1(n1361), 
        .Y(n533) );
  AOI22X1TS U1776 ( .A0(n924), .A1(intadd_55_SUM_2_), .B0(n1487), .B1(n1361), 
        .Y(n532) );
  XNOR2X1TS U1777 ( .A(DMP_SFG[9]), .B(n1350), .Y(n1351) );
  XNOR2X1TS U1778 ( .A(intadd_55_n1), .B(n1351), .Y(n1352) );
  AOI22X1TS U1779 ( .A0(n924), .A1(n1352), .B0(n1486), .B1(n1361), .Y(n531) );
  AOI2BB2XLTS U1780 ( .B0(DmP_mant_SFG_SWR[12]), .B1(n1358), .A0N(n1498), 
        .A1N(DmP_mant_SFG_SWR[12]), .Y(intadd_54_CI) );
  AOI2BB2XLTS U1781 ( .B0(n1353), .B1(intadd_54_SUM_0_), .A0N(
        Raw_mant_NRM_SWR[12]), .A1N(n1353), .Y(n530) );
  AOI2BB2XLTS U1782 ( .B0(DmP_mant_SFG_SWR[13]), .B1(n1358), .A0N(n1498), 
        .A1N(DmP_mant_SFG_SWR[13]), .Y(intadd_54_B_1_) );
  AOI22X1TS U1783 ( .A0(n1357), .A1(intadd_54_SUM_1_), .B0(n1509), .B1(n1361), 
        .Y(n529) );
  AOI2BB2XLTS U1784 ( .B0(DmP_mant_SFG_SWR[14]), .B1(n1358), .A0N(n1498), 
        .A1N(DmP_mant_SFG_SWR[14]), .Y(intadd_54_B_2_) );
  AOI22X1TS U1785 ( .A0(n1357), .A1(intadd_54_SUM_2_), .B0(n1497), .B1(n1361), 
        .Y(n528) );
  AOI2BB2XLTS U1786 ( .B0(DmP_mant_SFG_SWR[15]), .B1(n1358), .A0N(n1498), 
        .A1N(DmP_mant_SFG_SWR[15]), .Y(intadd_54_B_3_) );
  AOI22X1TS U1787 ( .A0(n1357), .A1(intadd_54_SUM_3_), .B0(n1496), .B1(n1361), 
        .Y(n527) );
  AOI22X1TS U1788 ( .A0(DmP_mant_SFG_SWR[16]), .A1(n1355), .B0(n1354), .B1(
        n919), .Y(intadd_54_B_4_) );
  AOI22X1TS U1789 ( .A0(n1357), .A1(intadd_54_SUM_4_), .B0(n1485), .B1(n1610), 
        .Y(n526) );
  AOI22X1TS U1790 ( .A0(DmP_mant_SFG_SWR[17]), .A1(n1355), .B0(n1354), .B1(
        n912), .Y(intadd_54_B_5_) );
  AOI22X1TS U1791 ( .A0(n1357), .A1(intadd_54_SUM_5_), .B0(n1514), .B1(n1610), 
        .Y(n525) );
  INVX1TS U1792 ( .A(DmP_mant_SFG_SWR[18]), .Y(n1461) );
  AOI22X1TS U1793 ( .A0(DmP_mant_SFG_SWR[18]), .A1(n1355), .B0(n1354), .B1(
        n1461), .Y(intadd_54_B_6_) );
  AOI2BB2XLTS U1794 ( .B0(n924), .B1(intadd_54_SUM_6_), .A0N(
  ...
  AOI22X1TS U1796 ( .A0(DmP_mant_SFG_SWR[19]), .A1(n1355), .B0(n1354), .B1(
        n1463), .Y(intadd_54_B_7_) );
  AOI2BB2XLTS U1797 ( .B0(n1353), .B1(intadd_54_SUM_7_), .A0N(
  ...
  AOI22X1TS U1799 ( .A0(DmP_mant_SFG_SWR[20]), .A1(n1355), .B0(n1354), .B1(
        n1465), .Y(intadd_54_B_8_) );
  AOI2BB2XLTS U1800 ( .B0(n924), .B1(intadd_54_SUM_8_), .A0N(
  ...
  AOI22X1TS U1802 ( .A0(DmP_mant_SFG_SWR[21]), .A1(n1355), .B0(n1354), .B1(
        n1467), .Y(intadd_54_B_9_) );
  AOI22X1TS U1803 ( .A0(n1357), .A1(intadd_54_SUM_9_), .B0(n1517), .B1(n1610), 
        .Y(n521) );
  INVX1TS U1804 ( .A(DmP_mant_SFG_SWR[22]), .Y(n1469) );
  AOI22X1TS U1805 ( .A0(DmP_mant_SFG_SWR[22]), .A1(n1355), .B0(n1354), .B1(
        n1469), .Y(intadd_54_B_10_) );
  AOI22X1TS U1806 ( .A0(n1357), .A1(intadd_54_SUM_10_), .B0(n1513), .B1(n1610), 
        .Y(n520) );
  INVX1TS U1807 ( .A(DmP_mant_SFG_SWR[23]), .Y(n1471) );
  AOI22X1TS U1808 ( .A0(DmP_mant_SFG_SWR[23]), .A1(n1355), .B0(n1359), .B1(
        n1471), .Y(intadd_54_B_11_) );
  AOI22X1TS U1809 ( .A0(n1357), .A1(intadd_54_SUM_11_), .B0(n1483), .B1(n1610), 
        .Y(n519) );
  INVX1TS U1810 ( .A(DmP_mant_SFG_SWR[24]), .Y(n1474) );
  AOI22X1TS U1811 ( .A0(DmP_mant_SFG_SWR[24]), .A1(n1355), .B0(n1354), .B1(
        n1474), .Y(intadd_54_B_12_) );
  AOI22X1TS U1812 ( .A0(n1357), .A1(intadd_54_SUM_12_), .B0(n1484), .B1(n1610), 
        .Y(n518) );
  AOI22X1TS U1813 ( .A0(DmP_mant_SFG_SWR[25]), .A1(n1359), .B0(n1358), .B1(
        n913), .Y(n1360) );
  XNOR2X1TS U1814 ( .A(intadd_54_n1), .B(n1360), .Y(n1362) );
...
initial $sdf_annotate("FPU_PIPELINED_FPADDSUB_ASIC_fpadd_approx_syn_constraints_clk30.tcl_GeArN16R4P4_syn.sdf"); 
 endmodule
