...
# DVE full session
# Saved on Fri Oct 21 18:10:45 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/local/ESTUDIANTES/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/ASIC_fpaddsub_arch3/integracion_fisica/simulacion_logica_sintesis/DOUBLE/FPU_ADD_PIPE_SYN_DOUBLE_v1.tcl" type="Debug">
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+DOUBLE +define+FRANCIS_LZD=1 +neg_tchk +sdfverbose -ucligui} -dir ../DOUBLE -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 20641.497 20748.532
...
gui_marker_move -id ${Wave.1} {C1} 20695
...
gui_view_scroll -id ${List.1} -vertical -set 169045
